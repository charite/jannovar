...
public class JannovarBaseOptions {
	...
	public void setFromArgs(Namespace args) throws CommandLineParsingException {
		...
		checkHttpProxy(args, env);
		checkHttpsProxy(args, env);
		checkingFTP_Proxy(args, env);
	}

	public void checkingFTP_Proxy(Namespace args, Map<String, String> env) throws CommandLineParsingException {
		try {
	...
	public void checkHttpsProxy(Namespace args, Map<String, String> env) throws CommandLineParsingException {
		try {
	...
	public void checkHttpProxy(Namespace args, Map<String, String> env) throws CommandLineParsingException {
		try {
	...
	public void checkVerbose(Namespace args) throws CommandLineParsingException {
