...
public class JannovarAnnotatePosOptions extends JannovarAnnotationOptions {
  ...
  public static void setupParser(Subparsers subParsers) {
    BiFunction<String[], Namespace, AnnotatePositionCommand> handler =
        (argv, args) -> {
          try {
    ...
    Subparser subParser =
        subParsers
            .addParser("annotate-pos", true)
            .help("annotate genomic changes given on the command line")
    ...
    requiredGroup
        .addArgument("-c", "--genomic-change")
        .help("Genomic change to annotate, you can give multiple ones")
  ...
  public String toString() {
    return "JannovarAnnotatePosOptions [genomicChanges="
        + genomicChanges
        + ", toString()="
        + super.toString()
        + "]";
