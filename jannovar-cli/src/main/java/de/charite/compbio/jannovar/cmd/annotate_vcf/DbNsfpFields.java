 ...
 *
 * <p>Defines preconfigured {@link GenericTSVValueColumnDescription}
 *
...
public class DbNsfpFields {
  ...
  static {
    ImmutableMap.Builder<String, GenericTSVValueColumnDescription> builder = ImmutableMap.builder();

    builder.put(
        "hg38_chr",
        new GenericTSVValueColumnDescription(
            1,
    ...
    builder.put(
        ...
        new GenericTSVValueColumnDescription(
            ...
            VCFHeaderLineType.Integer,
            "codon_degeneracy",
            "Value of dbNSFP column 'codon_degeneracy'",
            GenericTSVAccumulationStrategy.CHOOSE_FIRST));
    ...
    builder.put(
        ...
        new GenericTSVValueColumnDescription(
            ...
            VCFHeaderLineType.String,
            "Ancestral_allele",
            "Value of dbNSFP column 'Ancestral_allele'",
            GenericTSVAccumulationStrategy.CHOOSE_FIRST));
    builder.put(
        "AltaiNeandertal",
        new GenericTSVValueColumnDescription(
            ...
            VCFHeaderLineType.String,
            "AltaiNeandertal",
            "Value of dbNSFP column 'AltaiNeandertal'",
            GenericTSVAccumulationStrategy.CHOOSE_FIRST));
    builder.put(
        "Denisova",
        new GenericTSVValueColumnDescription(
    ...
    builder.put(
        ...
        new GenericTSVValueColumnDescription(
            ...
            VCFHeaderLineType.String,
            "Ensembl_transcriptid",
            "Value of dbNSFP column 'Ensembl_transcriptid'",
            GenericTSVAccumulationStrategy.CHOOSE_FIRST));
    builder.put(
        "Ensembl_proteinid",
        new GenericTSVValueColumnDescription(
            ...
            VCFHeaderLineType.String,
            "Ensembl_proteinid",
            "Value of dbNSFP column 'Ensembl_proteinid'",
            GenericTSVAccumulationStrategy.CHOOSE_FIRST));
    builder.put(
        "aapos",
        new GenericTSVValueColumnDescription(
    ...
    builder.put(
        ...
        new GenericTSVValueColumnDescription(
            ...
            GenericTSVAccumulationStrategy.CHOOSE_MIN,
            "SIFT_score"));
    builder.put(
    ...
    builder.put(
        ...
        new GenericTSVValueColumnDescription(
            ...
            VCFHeaderLineType.String,
            "Uniprot_acc_Polyphen2",
            "Value of dbNSFP column 'Uniprot_acc_Polyphen2'",
    ...
    builder.put(
        ...
        new GenericTSVValueColumnDescription(
            ...
            VCFHeaderLineType.String,
            "Uniprot_id_Polyphen2",
            "Value of dbNSFP column 'Uniprot_id_Polyphen2'",
            GenericTSVAccumulationStrategy.CHOOSE_MAX,
            "Polyphen2_HDIV_score"));
    builder.put(
    ...
    builder.put(
        ...
        new GenericTSVValueColumnDescription(
            ...
            VCFHeaderLineType.Integer,
            "Polyphen2_HDIV_score",
            "Value of dbNSFP column 'Polyphen2_HDIV_score'",
            GenericTSVAccumulationStrategy.CHOOSE_MAX,
            "Polyphen2_HDIV_score"));
    builder.put(
    ...
    builder.put(
        ...
        new GenericTSVValueColumnDescription(
            ...
            VCFHeaderLineType.String,
            "Polyphen2_HDIV_pred",
            "Value of dbNSFP column 'Polyphen2_HDIV_pred'",
            GenericTSVAccumulationStrategy.CHOOSE_MAX,
            "Polyphen2_HDIV_pred"));
    builder.put(
        ...
        new GenericTSVValueColumnDescription(
            ...
            VCFHeaderLineType.Integer,
            "Polyphen2_HVAR_score",
            "Value of dbNSFP column 'Polyphen2_HVAR_score'",
            GenericTSVAccumulationStrategy.CHOOSE_MAX,
            "Polyphen2_HDIV_score"));
    builder.put(
    ...
    builder.put(
        ...
        new GenericTSVValueColumnDescription(
            ...
            VCFHeaderLineType.Integer,
            "Polyphen2_HVAR_pred",
            "Value of dbNSFP column 'Polyphen2_HVAR_pred'",
            GenericTSVAccumulationStrategy.CHOOSE_MAX,
            "Polyphen2_HDIV_score"));
    ...
    builder.put(
        ...
        new GenericTSVValueColumnDescription(
            ...
            VCFHeaderLineType.Character,
            "MutationTaster_pred",
            "Value of dbNSFP column 'MutationTaster_pred'",
            GenericTSVAccumulationStrategy.CHOOSE_MAX,
            "MutationTaster_score"));
    builder.put(
        ...
        new GenericTSVValueColumnDescription(
            ...
            VCFHeaderLineType.String,
            "MutationTaster_model",
            "Value of dbNSFP column 'MutationTaster_model'",
            GenericTSVAccumulationStrategy.CHOOSE_MAX,
            "MutationTaster_score"));
    builder.put(
        "MutationTaster_AAE",
        new GenericTSVValueColumnDescription(
            ...
            VCFHeaderLineType.String,
            "MutationTaster_AAE",
            "Value of dbNSFP column 'MutationTaster_AAE'",
            GenericTSVAccumulationStrategy.CHOOSE_MAX,
            "MutationTaster_score"));
    ...
    builder.put(
        ...
        new GenericTSVValueColumnDescription(
            ...
            VCFHeaderLineType.Float,
            "MutationAssessor_score",
            "Value of dbNSFP column 'MutationAssessor_score'",
            GenericTSVAccumulationStrategy.CHOOSE_MAX,
            "MutationAssessor_score"));
    builder.put(
    ...
    builder.put(
        ...
        new GenericTSVValueColumnDescription(
            ...
            VCFHeaderLineType.String,
            "MutationAssessor_pred",
            "Value of dbNSFP column 'MutationAssessor_pred'",
            GenericTSVAccumulationStrategy.CHOOSE_MAX,
            "MutationAssessor_score"));
  ...
  public static String phastCons100way_vertebrate_rankscore =
  ...
  public static String ExAC_nonpsych_EAS_ACExAC_nonpsych_EAS_AF =
      "ExAC_nonpsych_EAS_ACExAC_nonpsych_EAS_AF";
