...
public class JannovarDBListOptions extends JannovarDBOptions {
  ...
  public static void setupParser(Subparsers subParsers) {
    BiFunction<String[], Namespace, DatabaseListCommand> handler =
        (argv, args) -> {
          try {
    ...
    Subparser subParser =
        subParsers
            .addParser("db-list", true)
            .help("list databases available for download")
    ...
    optionalGroup
        ...
        .setDefault(Lists.newArrayList("bundle:///default_sources.ini"))
