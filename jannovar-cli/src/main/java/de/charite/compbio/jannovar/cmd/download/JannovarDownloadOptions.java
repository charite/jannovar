...
public class JannovarDownloadOptions extends JannovarDBOptions {
  ...
  public static void setupParser(Subparsers subParsers) {
    BiFunction<String[], Namespace, DownloadCommand> handler =
        (argv, args) -> {
          try {
    ...
    Subparser subParser =
        subParsers
            .addParser("download", true)
            .help("download transcript databases")
    ...
    requiredGroup
        ...
        .help("Name of database to download, can be given multiple times")
    ...
    optionalGroup
        .addArgument("-s", "--data-source-list")
        .help("INI file with data source list")
        .setDefault(new ArrayList<String>(Arrays.asList("bundle:///default_sources.ini")))
        .action(Arguments.append());
    optionalGroup
        .addArgument("--download-dir")
        .help("Path to download directory")
        .setDefault("data");

    optionalGroup
        .addArgument("--gene-ids")
        .help("Optional list of genes to limit creation of database to")
        .setDefault(new ArrayList<String>())
        .nargs("+");
    optionalGroup
  ...
  public String toString() {
    return "JannovarDownloadOptions [downloadDir="
        + downloadDir
        + ", getDataSourceFiles()="
        + getDataSourceFiles()
        + ", isReportProgress()="
