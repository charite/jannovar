  ...
  public void run() throws JannovarException {
    ...
    try (VCFFileReader vcfReader = new VCFFileReader(new File(vcfPath), false)) {
      ...
      StatisticsCollector statsCollector =
          new StatisticsCollector(vcfReader.getFileHeader().getSampleNamesInOrder());
      ...
      try (StatisticsWriter writer =
          new StatisticsWriter(statsCollector, new File(options.getPathOutputReport()))) {
      ...
      System.err.println(
          String.format(
              "Annotation, statistics gathering and writing took %.2f sec.",
