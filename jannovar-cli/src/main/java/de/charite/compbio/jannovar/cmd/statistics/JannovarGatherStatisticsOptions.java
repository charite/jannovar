...
public class JannovarGatherStatisticsOptions extends JannovarBaseOptions {
  ...
  public static void setupParser(Subparsers subParsers) {
    BiFunction<String[], Namespace, GatherStatisticsCommand> handler =
        (argv, args) -> {
          try {
    ...
    Subparser subParser =
        subParsers
            .addParser("statistics", true)
            .help("compute statistics about VCF file")
    ...
    requiredGroup
        .addArgument("-o", "--output-report")
        .help("Path to output report TXT file")
        .required(true);
  ...
  public String toString() {
    return "JannovarGatherStatisticsOptions [databaseFilePath="
        + databaseFilePath
        + ", pathInputVCF="
        + pathInputVCF
        + ", pathOutputReport="
