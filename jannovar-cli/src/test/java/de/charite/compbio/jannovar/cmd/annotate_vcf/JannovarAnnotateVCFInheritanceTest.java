  ...
  public void testAnnotateAR() throws IOException, URISyntaxException {
    ...
    String[] argv =
        new String[] {
          "annotate-vcf",
          "-o",
          outFolder.toString() + "/pedigree_vars.jv_ar.vcf",
          "-d",
          pathToSmallSer,
          "-i",
          inputVCFPath,
    ...
    final File expectedFile =
        new File(this.getClass().getResource("/pedigree_vars.jv_ar.vcf").toURI().getPath());
  ...
  public void testAnnotateAD() throws IOException, URISyntaxException {
    ...
    String[] argv =
        new String[] {
          "annotate-vcf",
          "-o",
          outFolder.toString() + "/pedigree_vars.jv_ad.vcf",
          "-d",
          pathToSmallSer,
          "-i",
          inputVCFPath,
    ...
    final File expectedFile =
        new File(this.getClass().getResource("/pedigree_vars.jv_ad.vcf").toURI().getPath());
    final String expected = Files.asCharSource(expectedFile, Charsets.UTF_8).read();
    final String actual =
        Files.asCharSource(f, Charsets.UTF_8)
            .read()
