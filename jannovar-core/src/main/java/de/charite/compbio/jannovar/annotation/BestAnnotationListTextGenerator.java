...
/**
 * Decorator for {@link VariantAnnotations} for generating variant annotation strings for the best
 * variant
 *
...
public final class BestAnnotationListTextGenerator extends VariantAnnotationsTextGenerator {
  ...
  public BestAnnotationListTextGenerator(
      VariantAnnotations annotations, int alleleID, int altCount) {
