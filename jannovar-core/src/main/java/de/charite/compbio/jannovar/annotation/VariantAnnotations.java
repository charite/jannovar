...
public final class VariantAnnotations implements VariantDescription {
   ...
   *
   * <p>Note that <code>variant</code> is converted to the forward strand using {@link
   * GenomeVariant#withStrand}.
   *
   ...
   *
   * <p>Note that the {@link GenomeVariant} is converted to be on the forward strand on construction
   * of AnnotationList objects.
   *
  ...
  /**
   * @return {@link Annotation} with highest predicted impact, or <code>null</code> if there is
   *     none.
   */
   ...
   * Convenience method.
   *
   * @return {@link VariantEffect} with the highest impact of all in entries or {@link
   *     VariantEffect#SEQUENCE_VARIANT} if entries are empty or contain no annotated effects.
   */
