...
public class VariantAnnotationsContentDecorator {
  ...
  /**
   * @return <code>true</code> if the list contains a variant where {@link
  ...
  /**
   * @return the gene symbol of the annotation with highest priority or <code>null</code> if {@link
  ...
  /**
   * @return the gene ID of the variant with highest priority, or <code>null</code> if no such
   *     variant
   */
  ...
  /**
   * @return the {@link VariantEffect} of the variant with highest priority or <code>null</code> if
