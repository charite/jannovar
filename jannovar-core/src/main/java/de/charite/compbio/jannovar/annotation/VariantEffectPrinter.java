 ...
 *
 * <p>Run directly in Eclipse via right-click and "Run As > Java Application".
 */
class VariantEffectPrinter {
  ...
  public static void main(String[] args) {
    ...
    for (VariantEffect ve : VariantEffect.values())
      System.err.println(
          ve.getImpact() + "\t" + ve.getSequenceOID() + "\t" + ve.getSequenceOntologyTerm());
