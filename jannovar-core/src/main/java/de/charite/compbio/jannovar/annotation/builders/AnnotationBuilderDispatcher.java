...
/**
 * Dispatches annotation building to the specific classes, depending on their {@link
...
public final class AnnotationBuilderDispatcher {
  ...
  private static final ImmutableSet<VariantEffect> INTERGENIC_VARIANT =
      Sets.immutableEnumSet(EnumSet.of(VariantEffect.INTERGENIC_VARIANT));
  ...
  public AnnotationBuilderDispatcher(
