...
public class AnnotationBuilderOptions {
  ...
  /**
   * whether or not to override transcript sequence with user input, that is the sequence in the
   * {@link GenomeVariant} (default is <code>false</code>).
   */
  ...
  public AnnotationBuilderOptions(
      boolean nt3PrimeShifting, boolean overrideTxSeqWithGenomeVariantRef) {
    this.nt3PrimeShifting = nt3PrimeShifting;
    this.overrideTxSeqWithGenomeVariantRef = overrideTxSeqWithGenomeVariantRef;
  }

  /**
   * @return whether or not to shift variants towards the 3' end of the transcript (default is
   *     <code>true</code>)
   */
  ...
  /**
   * @return whether or not to override transcript sequence with user input, that is the sequence in
   *     the {@link GenomeVariant}
   */
