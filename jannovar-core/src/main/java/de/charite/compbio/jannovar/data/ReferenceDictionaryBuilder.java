...
public final class ReferenceDictionaryBuilder {
  ...
  private final ImmutableMap.Builder<String, Integer> contigID =
  ...
  private final ImmutableMap.Builder<Integer, String> contigName =
  ...
  private final ImmutableMap.Builder<Integer, Integer> contigLength =
  ...
  /**
   * Allows contig name to numeric ID translation before final construction of the {@link
   * ReferenceDictionary}.
   *
   * @param name name of contig to get numeric ID for
   * @return canonical numeric ID for the contig with given <code>name</code> or <code>null</code>
   *     if none.
   */
