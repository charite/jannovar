 ...
 *
 * <p>Data sources combine the information of (1) a name, (2) a list of URLs with files to download,
 * and (3) obtaining a factory for constructing a {@link JannovarData} object from this information.
 *
...
public abstract class DataSource {
   ...
   * @throws InvalidDataSourceException if there are problems with retrieving or parsing the URL
   *     string
   */
