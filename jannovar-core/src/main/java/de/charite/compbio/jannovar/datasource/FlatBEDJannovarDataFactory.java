...
public class FlatBEDJannovarDataFactory extends JannovarDataFactory {
   ...
   *
   * <p>{@code geneIdentifiers} is being ignored.
   *
   * @param options configuration for proxy settings
   * @param dataSource the data source to use.
   * @param geneIdentifiers list of gene identifiers to include
   * @param iniSection {@link Section} with configuration from INI file
   */
  public FlatBEDJannovarDataFactory(
      DatasourceOptions options, DataSource dataSource, Section iniSection) {
