...
/**
 * Representation of the relevant entries from one record from the <tt>hgnc_complete_set.txt</tt>
 * file.
 *
...
public class HGNCRecord {
  ...
  public HGNCRecord(
      ...
      String symbol,
      String name,
      Collection<String> aliasSymbols,
      Collection<String> prevSymbol,
      String entrezID,
