...
public class TranscriptSupportLevelsSetterFromLengths {
  ...
  private static final Logger LOGGER =
      LoggerFactory.getLogger(TranscriptSupportLevelsSetterFromLengths.class);
  ...
  /**
   * Set the level of the longest {@link TranscriptModelBuilder} objects for each gene to {@link
   * TranscriptSupportLevels.LONGEST_TRANSCRIPT}.
   *
  ...
  /**
   * Set the level of all {@link TranscriptModelBuilder} objects to {@link
   * TranscriptSupportLevels.LOW_PRIORITY}.
   *
   * @param values the {@link TranscriptModelBuilder} to set the levels of to {@link
   *     TranscriptSupportLevels.LOW_PRIORITY}.
   */
