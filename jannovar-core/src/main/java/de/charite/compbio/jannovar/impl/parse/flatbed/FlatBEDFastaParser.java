 ...
 *
 * <p>An {@link ArrayList} of {@link TranscriptModelBuilder}s is passed to this class together with
 * the path to the corresponding FASTA file, containing the sequence informations for the {@link
 * TranscriptModelBuilder}s.
 *
...
public final class FlatBEDFastaParser /*extends FastaParser*/ {
  ...
  public FlatBEDFastaParser(
      String filename, ArrayList<TranscriptModelBuilder> models, boolean printProgressBars) {
