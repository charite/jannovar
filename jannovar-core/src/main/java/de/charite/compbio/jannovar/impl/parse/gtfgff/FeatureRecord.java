 ...
 *
 * <p>When comparing, features on the forward strand come before features on the reverse strand.
 *
...
public final class FeatureRecord implements Comparable<FeatureRecord> {
  ...
  public int compareTo(FeatureRecord o) {
    return ComparisonChain.start()
        .compare(seqID, o.seqID)
        .compare(strand, o.strand)
