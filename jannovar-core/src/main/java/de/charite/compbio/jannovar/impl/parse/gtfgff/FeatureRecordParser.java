...
public abstract class FeatureRecordParser {
  ...
  public FeatureRecord parseLine(String line) {
    ...
    FeatureRecord.Strand strand =
        arr[6].equals("+") ? FeatureRecord.Strand.FORWARD : FeatureRecord.Strand.REVERSE;
    ...
    FeatureRecord result =
        new FeatureRecord(
            chrom, source, type, beginPos, endPos, score, strand, phase, parseAttributes(arr[8]));
