 ...
 *
 * <p>This class is state-ful and not thread safe.
 *
...
public class GFFParser {
  ...
  /**
   * Reads next record from the GFF file and return it, <code>null</code> when the file is at its
   * end.
   *
   ...
   *
   * @return {@link InputStream}, wrapping a gzip reading stream if <code>stream</code> is gzip
   *     compressed
   * @throws IOException on I/O problems
   */
