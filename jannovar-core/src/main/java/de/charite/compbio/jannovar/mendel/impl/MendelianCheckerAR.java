 ...
 *
 * This class merely delegates to the {@link MendelianCheckerARHom} and {@link
 * MendelianCheckerARCompoundHet}. The {@link GenotypeCalls} objects passing either filter will be
 * returned.
 *
...
public class MendelianCheckerAR extends AbstractMendelianChecker {
  ...
  private final MendelianCheckerARCompoundHet checkerCompound;
  private final MendelianCheckerARHom checkerHom;
  ...
  public ImmutableList<GenotypeCalls> filterCompatibleRecords(Collection<GenotypeCalls> calls)
    ...
    Stream<GenotypeCalls> joint =
        Stream.concat(
            checkerCompound.filterCompatibleRecords(calls).stream(),
