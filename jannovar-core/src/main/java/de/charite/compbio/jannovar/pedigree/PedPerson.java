 ...
 *
 * <p>A pedigree file is a TSV file and contains information about multiple indivdidual. Each line
 * is a record and describes an individual. The files have six <b>core columns</b> that have to be
 * present:
 *
 * <dl>
 *   <dt>{@link #pedigree}
 *   <dd>the name of the pedigree
 *   <dt>{@link #name}
 *   <dd>the name of the individual
 *   <dt>{@link #father}
 *   <dd>the name of the individual's father
 *   <dt>{@link #mother}
 *   <dd>the name of the individual's mother
 *   <dt>{@link #sex}
 *   <dd>the sex of the individual
 *   <dt>{@link #disease}
 *   <dd>the disease status of the individual
 * </dl>
 *
 * The remaining columns are stored in {@link #extraFields}.
 *
 * <p>The <code>PedPerson</code> class describes a record from a pedigree file. This introduces some
 * limitations. For example, the record stores the id of the parents but not references to the
 * parent objects. The class {@link Person} provides a more Java-programmer oriented version of this
 * information.
 *
...
public final class PedPerson {
  ...
  /** Initialize object with the given data. */
  public PedPerson(
      String pedigree, String name, String father, String mother, Sex sex, Disease disease) {
