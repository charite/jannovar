...
public class PedigreeQueryDecorator {
  ...
  /**
   * @return sibling map for each {@link Person} in {@link Pedigree}, both parents must be in {@link
   *     Pedigree} and the same pedigree
   */
  public ImmutableMap<Person, ImmutableList<Person>> buildSiblings() {
    ImmutableMap.Builder<Person, ImmutableList<Person>> mapBuilder =
