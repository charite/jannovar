 ...
 *
 * <p>Note that a Person is not truly immutable since its mother and father field have to be
 * non-final during its construction. However, since the members only have <code>package</code>
 * visibility, <code>Person</code> is immutable for all practical considerations after construction.
 *
...
public final class Person {
  ...
  /**
   * Constructor used by {@link PedigreeExtractor} for construction of pedigrees with potential
   * cycles.
   */
  ...
  /**
   * @return <code>true</code> if the person is a founder (neither mother nor father in {@link
   *     Pedigree})
   */
