...
// TODO(holtgrewe): We only want genome changes on the forward strand, make sure this does not lead
 ...
 *
 * <p>GenomeChange objects are immutable, the members are automatically adjusted for the longest
 * common suffix and prefix in REF and ALT.
 *
 * <p>Symbolic alleles, as in the VCF standard, are also possible, but methods like {@link #getType}
 * etc. do not return sensible results.
 *
...
public final class GenomeVariant implements VariantDescription {
   ...
   *
   * <p>On construction, pos, ref, and alt are automatically adjusted to the right/incremented by
   * the length of the longest common prefix and suffix of ref and alt.
   */
   ...
   *
   * <p>On construction, pos, ref, and alt are automatically adjusted to the right/incremented by
   * the length of the longest common prefix and suffix of ref and alt. Further, the position is
   * adjusted to the given strand.
   */
   ...
   *     (events not described by replacement of bases, e.g. break-ends or duplications that are
  ...
  /**
   * A transition is between purine and purine or between pyrimidine and pyrimidine. Only applies to
  ...
  public int compareTo(Annotation other) {
    return ComparisonChain.start()
        .compare(pos, other.getPos())
        .compare(ref, other.getRef())
        .compare(alt, other.getAlt())
        .result();
  }
}
