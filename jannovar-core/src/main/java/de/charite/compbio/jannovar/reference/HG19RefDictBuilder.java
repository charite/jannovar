 ...
 *
 * <p>This is a utility class that can be used in tests of Java code that uses the Jannovar library
 * for the easy construction of a {@link ReferenceDictionary}.
 *
