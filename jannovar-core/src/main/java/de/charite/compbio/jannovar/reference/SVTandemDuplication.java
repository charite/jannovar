 ...
 */
public final class SVTandemDuplication extends SVGenomeVariant {
	 ...
	 */
	public SVTandemDuplication(GenomePosition genomePos, GenomePosition genomePos2, int posCILowerBound,
	...
	public SVDescription.Type getType() {
		return SVDescription.Type.DUP_TANDEM;
	}

	@Override
	public SVTandemDuplication withStrand(Strand strand) {
		if (genomePos.getStrand() != strand) {
			return new SVTandemDuplication(
