 ...
 *
 * <p>In this sense, it is similar to {@link StringBuilder} for building {@link String} objects.
 *
 * <p>Usage:
 *
 * <pre>
...
public class TranscriptModelBuilder {
  ...
  public TranscriptModel build() {
    ...
    ImmutableSortedSet.Builder<GenomeInterval> builder =
    ...
    return new TranscriptModel(
        accession,
        geneSymbol,
        txRegion.withStrand(strand),
        cdsRegion.withStrand(strand),
