...
public final class TranscriptSequenceDecorator {
  ...
  /**
   * Update the base given by <code>frameShift</code> in the given codon string <code>
   * transcriptCodon</code> to <code>targetNC</code> and return updated codon.
   *
  ...
  /**
   * Insert the string in <code>insertion</code> at the position given by <code>frameShift</code> in
   * the given codon string <code>transcriptCodon</code> to <code>targetNC</code> and return the
   * updated nucleic string.
   *
  ...
  /**
   * Returns a number of codons (String of length 3 * <code>len</code>) starting from the affected
   * one by the change at <code>txPos</code>/<code>cdsPos</code>.
   *
   * <p>If there is not a sufficient number of nucleotides in the transcript string then return
   * fewer, only up to the end.
   *
   * @param txPos transcript position of the change
   * @param cdsPos CDS position of the change
  ...
  /**
   * Returns all codons (String of length 3 * <code>len</code>) starting from the affected one by
   * the change at <code>txPos</code>/<code>cdsPos</code>.
   *
   * @param txPos transcript position of the change
   * @param cdsPos CDS position of the change
   * @return the codon affected by a change at the given position
