...
/**
 * Functionality for finding out about certain points/regions of {@link TranscriptModel} using
 * <b>genomic</b> positions.
 *
...
public final class TranscriptSequenceOntologyDecorator {
  ...
  public GenomeInterval getFivePrimeUTRInterval() {
    ...
    int fivePrimeUTRLen =
        transcript.getCDSRegion().getGenomeBeginPos().differenceTo(fivePrimeUTRBeginPos);
  ...
  public GenomeInterval getThreePrimeUTRInterval() {
    ...
    int threePrimeUTRLen =
        transcript.getTXRegion().getGenomeEndPos().differenceTo(threePrimeUTRBeginPos);
  ...
  /**
   * @param interval query whether <code>interval</code> overlaps with a CDS exon (exon that
   *     overlaps with CDS)
   ...
   * @return <code>true</code> if the {@link GenomeInterval} falls fully into the coding part of an
   *     exon
   */
   ...
   * @return <code>true</code> if the {@link GenomePosition} points to a base in the coding part of
   *     an exon
   */
   ...
   * @return <code>true</code> if <code>interval</code> overlaps with the CDS region of the
   *     transcript
   */
   ...
   * @return <code>true</code> if <code>changeInterval</code> overlaps with an intron of {@link
   *     #transcript}
   */
   ...
   * @param changeInterval the {@link GenomeInterval} to use for the query
   * @return <code>true</code> if <code>changeInterval</code> overlaps with an intron of {@link
   *     #transcript} that overlaps with the CDS
   */
  ...
  /**
   * @return <code>true</code> if the {@link GenomePosition} lies within an intron of {@link
   *     #transcript} that overlaps with the CDS
   */
  ...
  /**
   * @param interval the {@link GenomeInterval} to use for querying
   * @return <code>true</code> if the {@link GenomeInterval} overlaps with the translational start
   *     site
   */
  ...
  /**
   * @return <code>true</code> if the {@link GenomePosition} lies within the translational start
   *     site
   */
  ...
  /**
   * @param interval the {@link GenomeInterval} to use for querying
   * @return <code>true</code> if the {@link GenomeInterval} overlaps with the translational stop
   *     site
   */
   ...
   *
   * <p>A splice_region_variant is a sequence variant in which a change has occurred within the
   * region of the splice site, either within 1-3 bases of the exon or 3-8 bases of the intron.
   *
   * @param interval the {@link GenomeInterval} to use for querying
   ...
   *
   * <p>A splice variant that changes the 2 base pair region at the 5' end of an intron.
   *
   * @param interval the {@link GenomeInterval} to use for querying
   ...
   *
   * <p>A splice variant that changes the 2 base pair region at the 3' end of an intron.
   *
   * @param interval the {@link GenomeInterval} to use for querying
  ...
  /**
   * Returns whether the given <code>interval</code> overlaps with the upstream region of the
   * transcript.
   *
   * <p>The upstream region of the transcript is up to 1000 bp upstream of the transcript.
   *
   * @param interval the {@link GenomeInterval} to use for querying
   * @return <code>true</code> if the {@link GenomeInterval} overlaps with the upstream region of
   *     the transcript.
   */
  ...
  /**
   * Returns whether the given <code>pos</code> lies within with the upstream region of the
   * transcript.
   *
   * <p>The upstream region of the transcript is up to 1000 bp upstream of the transcript.
   *
   * @param pos the {@link GenomePosition} to use for querying
   * @return <code>true</code> if the {@link GenomePosition} lies within the upstream region of the
   *     transcript.
   */
  ...
  /**
   * Returns whether the given <code>interval</code> overlaps with the downstream region of the
   * transcript.
   *
   * <p>The upstream region of the transcript is up to 1000 bp upstream of the transcript.
   *
   * @param interval the {@link GenomeInterval} to use for querying
   * @return <code>true</code> if the {@link GenomeInterval} overlaps with the downstream region of
   *     the transcript.
   */
  ...
  /**
   * Returns whether the given <code>pos</code> lies within with the downstream region of the
   * transcript.
   *
   * <p>The upstream region of the transcript is up to 1000 bp downstream of the transcript.
   *
   * @param pos the {@link GenomePosition} to use for querying
   * @return <code>true</code> if the {@link GenomePosition} lies within the downstream region of
   *     the transcript.
   */
  ...
  public boolean liesInIntron(GenomeInterval interval) {
    ...
    return !transcript
        .getExonRegions()
        .get(intronNo + 1)
        .contains(interval.getGenomeEndPos().shifted(-1));
  }
