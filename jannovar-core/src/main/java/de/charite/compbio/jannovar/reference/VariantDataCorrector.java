 ...
 *
 * <p>The longest prefix of ref and alt is removed and position is incremented by the number of
 * removed characters.
 *
 * <p>This is used in the constructor {@link GenomeVariant} so there is no need for using this class
 * directly when the change is converted into a {@link GenomeVariant} before processing. This class
 * has package-visibility only because its members are visible to the outside. Rather construct a
 * {@link GenomeVariant} and use this immutable class.
 *
