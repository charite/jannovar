...
//		jun = jvData.getTmByAccession().get("NM_002228.3");
	...
	public void testTranscriptDuplicationOma1() {
		final SVDuplication svDup = new SVDuplication(
		...
		final SVAnnotation anno = new SVDuplicationAnnotationBuilder(oma1, svDup).build();

		Assert.assertEquals(anno.getTranscript().toString(), "NM_145243.3(1:g.58946391_59012446)");
		Assert.assertEquals(
			"SVDuplication{genomePos=1:g.58929878, genomePos2=1:g.59028961, posCILowerBound=0, " +
				"posCIUpperBound=0, pos2CILowerBound=0, pos2CIUpperBound=0}",
			anno.getVariant().toString()
		);
		Assert.assertEquals(
			"[TRANSCRIPT_AMPLIFICATION, STRUCTURAL_VARIANT, CODING_TRANSCRIPT_VARIANT]",
	...
	public void testExonDuplicationOma1() {
		...
		Assert.assertEquals(anno.getTranscript().toString(), "NM_145243.3(1:g.58946391_59012446)");
		Assert.assertEquals(
			"SVDuplication{genomePos=1:g.58968129, genomePos2=1:g.58994821, posCILowerBound=0, " +
				"posCIUpperBound=0, pos2CILowerBound=0, pos2CIUpperBound=0}",
			anno.getVariant().toString()
		);
		Assert.assertEquals(
	...
	public void testExonOverlapStartDuplicatedOma1() {
		...
		Assert.assertEquals(anno.getTranscript().toString(), "NM_145243.3(1:g.58946391_59012446)");
		Assert.assertEquals(
			"SVDuplication{genomePos=1:g.59004876, genomePos2=1:g.59005053, posCILowerBound=0, " +
				"posCIUpperBound=0, pos2CILowerBound=0, pos2CIUpperBound=0}",
			anno.getVariant().toString()
		);
		Assert.assertEquals(
	...
	public void testExonOverlapStopDuplicatedOma1() {
		...
		Assert.assertEquals(anno.getTranscript().toString(), "NM_145243.3(1:g.58946391_59012446)");
		Assert.assertEquals(
			"SVDuplication{genomePos=1:g.5894660, genomePos2=1:g.58946672, posCILowerBound=0, " +
				"posCIUpperBound=0, pos2CILowerBound=0, pos2CIUpperBound=0}",
			anno.getVariant().toString()
		);
		Assert.assertEquals(
	...
	public void testExonOverlapDuplicationOma1() {
		...
		Assert.assertEquals(anno.getTranscript().toString(), "NM_145243.3(1:g.58946391_59012446)");
		Assert.assertEquals(
			"SVDuplication{genomePos=1:g.58946845, genomePos2=1:g.58946947, posCILowerBound=0, " +
				"posCIUpperBound=0, pos2CILowerBound=0, pos2CIUpperBound=0}",
			anno.getVariant().toString()
		);
		Assert.assertEquals(
	...
	public void testExonOverlapNoFrameshiftOma1() {
		...
		Assert.assertEquals(anno.getTranscript().toString(), "NM_145243.3(1:g.58946391_59012446)");
		Assert.assertEquals(
			"SVDuplication{genomePos=1:g.58946844, genomePos2=1:g.58946947, posCILowerBound=0, " +
				"posCIUpperBound=0, pos2CILowerBound=0, pos2CIUpperBound=0}",
			anno.getVariant().toString()
		);
		Assert.assertEquals(
	...
	public void testIntronicOma1() {
		...
		Assert.assertEquals(anno.getTranscript().toString(), "NM_145243.3(1:g.58946391_59012446)");
		Assert.assertEquals(
			"SVDuplication{genomePos=1:g.58957158, genomePos2=1:g.58963901, posCILowerBound=0, " +
				"posCIUpperBound=0, pos2CILowerBound=0, pos2CIUpperBound=0}",
			anno.getVariant().toString()
		);
		Assert.assertEquals(
	...
	public void testUpstreamOma1() {
		...
		Assert.assertEquals(anno.getTranscript().toString(), "NM_145243.3(1:g.58946391_59012446)");
		Assert.assertEquals(
			"SVDuplication{genomePos=1:g.59012450, genomePos2=1:g.59012900, posCILowerBound=0, " +
				"posCIUpperBound=0, pos2CILowerBound=0, pos2CIUpperBound=0}",
			anno.getVariant().toString()
		);
		Assert.assertEquals(
	...
	public void testDownstreamOma1() {
		...
		Assert.assertEquals(anno.getTranscript().toString(), "NM_145243.3(1:g.58946391_59012446)");
		Assert.assertEquals(
			"SVDuplication{genomePos=1:g.58942734, genomePos2=1:g.58946075, posCILowerBound=0, " +
				"posCIUpperBound=0, pos2CILowerBound=0, pos2CIUpperBound=0}",
			anno.getVariant().toString()
		);
		Assert.assertEquals(
	...
	public void testIntergenicOma1() {
		...
		Assert.assertEquals(anno.getTranscript().toString(), "NM_145243.3(1:g.58946391_59012446)");
		Assert.assertEquals(
			"SVDuplication{genomePos=1:g.59017450, genomePos2=1:g.59017900, posCILowerBound=0, " +
				"posCIUpperBound=0, pos2CILowerBound=0, pos2CIUpperBound=0}",
			anno.getVariant().toString()
		);
		Assert.assertEquals(
