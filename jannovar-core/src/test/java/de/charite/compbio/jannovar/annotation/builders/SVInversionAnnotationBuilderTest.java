...
public class SVInversionAnnotationBuilderTest {
...
//		jun = jvData.getTmByAccession().get("NM_002228.3");
	...
	@Test
	public void testTranscriptInversionOma1() {
		final SVInversion svInv = new SVInversion(
	...
	@Test
	public void testExonInversionOma1() {
		final SVInversion svInv = new SVInversion(
	...
	@Test
	public void testExonOverlapStartInvertedOma1() {
		final SVInversion svInv = new SVInversion(
	...
	@Test
	public void testExonOverlapStopInvertedOma1() {
		final SVInversion svInv = new SVInversion(
	...
	@Test
	public void testExonOverlapInversionOma1() {
		final SVInversion svInv = new SVInversion(
