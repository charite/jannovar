...
public class SVMobileElementDeletionAnnotationBuilderTest {
...
//		jun = jvData.getTmByAccession().get("NM_002228.3");
	...
	public void testTranscriptAblationOma1() {
		final SVMobileElementDeletion svMEDel = new SVMobileElementDeletion(
		...
		final SVAnnotation anno = new SVMobileElementDeletionAnnotationBuilder(oma1, svMEDel).build();

		Assert.assertEquals(anno.getTranscript().toString(), "NM_145243.3(1:g.58946391_59012446)");
		Assert.assertEquals(
			"SVMobileElementDeletion{genomePos=1:g.58929878, genomePos2=1:g.59028961, posCILowerBound=0, " +
				"posCIUpperBound=0, pos2CILowerBound=0, pos2CIUpperBound=0}",
			anno.getVariant().toString()
		);
		Assert.assertEquals(
			"[TRANSCRIPT_ABLATION, MOBILE_ELEMENT_DELETION, CODING_TRANSCRIPT_VARIANT]",
	...
	public void testExonLossOma1() {
		...
		Assert.assertEquals(anno.getTranscript().toString(), "NM_145243.3(1:g.58946391_59012446)");
		Assert.assertEquals(
			"SVMobileElementDeletion{genomePos=1:g.58968129, genomePos2=1:g.58994821, posCILowerBound=0, " +
				"posCIUpperBound=0, pos2CILowerBound=0, pos2CIUpperBound=0}",
			anno.getVariant().toString()
		);
		Assert.assertEquals(
			"[EXON_LOSS_VARIANT, MOBILE_ELEMENT_DELETION, CODING_TRANSCRIPT_VARIANT]",
			anno.getEffects().toString()
		);
	}
	...
	public void testExonOverlapStartLostOma1() {
		...
		Assert.assertEquals(anno.getTranscript().toString(), "NM_145243.3(1:g.58946391_59012446)");
		Assert.assertEquals(
			"SVMobileElementDeletion{genomePos=1:g.59004876, genomePos2=1:g.59005053, posCILowerBound=0, " +
				"posCIUpperBound=0, pos2CILowerBound=0, pos2CIUpperBound=0}",
			anno.getVariant().toString()
		);
		Assert.assertEquals(
			"[START_LOST, MOBILE_ELEMENT_DELETION, CODING_TRANSCRIPT_VARIANT]",
			anno.getEffects().toString()
		);
	}
	...
	public void testExonOverlapStopLostOma1() {
		...
		Assert.assertEquals(anno.getTranscript().toString(), "NM_145243.3(1:g.58946391_59012446)");
		Assert.assertEquals(
			"SVMobileElementDeletion{genomePos=1:g.58946591, genomePos2=1:g.58946672, posCILowerBound=0, " +
				"posCIUpperBound=0, pos2CILowerBound=0, pos2CIUpperBound=0}",
			anno.getVariant().toString()
		);
		Assert.assertEquals(
			"[STOP_LOST, MOBILE_ELEMENT_DELETION, CODING_TRANSCRIPT_VARIANT]",
			anno.getEffects().toString()
		);
	}
	...
	public void testExonOverlapFrameshiftOma1() {
		...
		Assert.assertEquals(anno.getTranscript().toString(), "NM_145243.3(1:g.58946391_59012446)");
		Assert.assertEquals(
			"SVMobileElementDeletion{genomePos=1:g.58946845, genomePos2=1:g.58946947, posCILowerBound=0, " +
				"posCIUpperBound=0, pos2CILowerBound=0, pos2CIUpperBound=0}",
			anno.getVariant().toString()
		);
		Assert.assertEquals(
			"[FRAMESHIFT_TRUNCATION, MOBILE_ELEMENT_DELETION, CODING_TRANSCRIPT_VARIANT]",
			anno.getEffects().toString()
		);
	}
	...
	public void testExonOverlapNoFrameshiftOma1() {
		...
		Assert.assertEquals(anno.getTranscript().toString(), "NM_145243.3(1:g.58946391_59012446)");
		Assert.assertEquals(
			"SVMobileElementDeletion{genomePos=1:g.58946844, genomePos2=1:g.58946947, posCILowerBound=0, " +
				"posCIUpperBound=0, pos2CILowerBound=0, pos2CIUpperBound=0}",
			anno.getVariant().toString()
		);
		Assert.assertEquals(
			"[FEATURE_TRUNCATION, MOBILE_ELEMENT_DELETION, CODING_TRANSCRIPT_VARIANT]",
			anno.getEffects().toString()
		);
	}
	...
	public void testIntronicOma1() {
		...
		Assert.assertEquals(anno.getTranscript().toString(), "NM_145243.3(1:g.58946391_59012446)");
		Assert.assertEquals(
			"SVMobileElementDeletion{genomePos=1:g.58957158, genomePos2=1:g.58963901, posCILowerBound=0, " +
				"posCIUpperBound=0, pos2CILowerBound=0, pos2CIUpperBound=0}",
			anno.getVariant().toString()
		);
		Assert.assertEquals(
			"[CODING_TRANSCRIPT_INTRON_VARIANT, MOBILE_ELEMENT_DELETION, CODING_TRANSCRIPT_VARIANT]",
			anno.getEffects().toString()
		);
	}
	...
	public void testUpstreamOma1() {
		...
		Assert.assertEquals(anno.getTranscript().toString(), "NM_145243.3(1:g.58946391_59012446)");
		Assert.assertEquals(
			"SVMobileElementDeletion{genomePos=1:g.59012450, genomePos2=1:g.59012900, posCILowerBound=0, " +
				"posCIUpperBound=0, pos2CILowerBound=0, pos2CIUpperBound=0}",
			anno.getVariant().toString()
		);
		Assert.assertEquals(
	...
	public void testDownstreamOma1() {
		...
		Assert.assertEquals(anno.getTranscript().toString(), "NM_145243.3(1:g.58946391_59012446)");
		Assert.assertEquals(
			"SVMobileElementDeletion{genomePos=1:g.58942734, genomePos2=1:g.58946075, posCILowerBound=0, " +
				"posCIUpperBound=0, pos2CILowerBound=0, pos2CIUpperBound=0}",
			anno.getVariant().toString()
		);
		Assert.assertEquals(
	...
	public void testIntergenicOma1() {
		...
		Assert.assertEquals(anno.getTranscript().toString(), "NM_145243.3(1:g.58946391_59012446)");
		Assert.assertEquals(
			"SVMobileElementDeletion{genomePos=1:g.59017450, genomePos2=1:g.59017900, posCILowerBound=0, " +
				"posCIUpperBound=0, pos2CILowerBound=0, pos2CIUpperBound=0}",
			anno.getVariant().toString()
		);
		Assert.assertEquals(
