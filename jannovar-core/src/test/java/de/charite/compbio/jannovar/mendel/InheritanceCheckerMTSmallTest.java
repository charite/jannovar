...
public class InheritanceCheckerMTSmallTest extends MendelianCompatibilityCheckerTestBase {
	...
	/**
	 * Affected Okay but one unaffected has it HET
	 * TODO Should we really filter that or should we leave it?
	 * 
	 * @throws IncompatiblePedigreeException
	 */
	@Test
	...
	/**
	 * The checker object has a pedigree with an affected mother, son, and daughter
	 * as well as an unaffected father in the order father, mother, son, daughter.
	 * Adding REF, HET, ALT, REF means that the pedigree should be judged compatible
...
//		gcList = getGenotypeCallsList(lst(REF, HET, ALT, REF), ChromosomeType.MITOCHONDRIAL);
//		MendelianInheritanceChecker checkerForInconsistentCase = new MendelianInheritanceChecker(
