...
public class MendelianCompatibilityCheckerADLargeTest
  ...
  public void setUp() throws Exception {
    ...
    this.names =
        ImmutableList.of(
            "I.1", "I.2", "II.1", "II.2", "II.3", "II.4", "II.5", "III.1", "III.2", "III.3",
            "III.4", "III.5", "III.6");
  ...
  public void testCaseNegativesOneVariant1() throws IncompatiblePedigreeException {
    gcList =
        getGenotypeCallsList(
            lst(HET, HET, HET, HET, HET, HET, HET, HET, HET, HET, HET, HET, HET),
  ...
  public void testCaseNegativesOneVariant2() throws IncompatiblePedigreeException {
    gcList =
        getGenotypeCallsList(
            lst(REF, REF, REF, REF, REF, REF, REF, REF, REF, REF, REF, REF, REF),
            ChromosomeType.AUTOSOMAL);
    result = checker.checkMendelianInheritance(gcList);
  ...
  public void testCaseNegativesOneVariant3() throws IncompatiblePedigreeException {
    gcList =
        getGenotypeCallsList(
            lst(ALT, ALT, ALT, ALT, ALT, ALT, ALT, ALT, ALT, ALT, ALT, ALT, ALT),
            ChromosomeType.AUTOSOMAL);
    result = checker.checkMendelianInheritance(gcList);
  ...
  public void testCaseNegativesOneVariant4() throws IncompatiblePedigreeException {
    gcList =
        getGenotypeCallsList(
            lst(UKN, UKN, UKN, UKN, UKN, UKN, UKN, UKN, UKN, UKN, UKN, UKN, UKN),
            ChromosomeType.AUTOSOMAL);
    result = checker.checkMendelianInheritance(gcList);
  ...
  public void testCaseNegativesOneVariant5() throws IncompatiblePedigreeException {
    ...
    gcList =
        getGenotypeCallsList(
            lst(REF, REF, REF, UKN, REF, UKN, UKN, REF, REF, UKN, REF, REF, UKN),
            ChromosomeType.AUTOSOMAL);
    result = checker.checkMendelianInheritance(gcList);
  ...
  // Note that the following cases are NOT considered as AD since we require the mutation to be
  // heterozygous for AD.
  ...
  public void testCaseNegativesOneVariant6() throws IncompatiblePedigreeException {
    gcList =
        getGenotypeCallsList(
            lst(REF, REF, REF, ALT, REF, ALT, ALT, REF, REF, ALT, REF, REF, ALT),
            ChromosomeType.AUTOSOMAL);
    result = checker.checkMendelianInheritance(gcList);
  ...
  public void testCaseNegativesOneVariant7() throws IncompatiblePedigreeException {
    gcList =
        getGenotypeCallsList(
            lst(REF, REF, REF, ALT, REF, ALT, HET, REF, REF, ALT, REF, REF, ALT),
            ChromosomeType.AUTOSOMAL);
    result = checker.checkMendelianInheritance(gcList);
  ...
  public void testCaseNegativesOneVariant8() throws IncompatiblePedigreeException {
    gcList =
        getGenotypeCallsList(
            lst(REF, REF, REF, HET, REF, HET, UKN, REF, REF, HET, REF, REF, ALT),
            ChromosomeType.AUTOSOMAL);
    result = checker.checkMendelianInheritance(gcList);
  ...
  public void testCasePositivesOneVariant1() throws IncompatiblePedigreeException {
    gcList =
        getGenotypeCallsList(
            lst(REF, REF, REF, HET, REF, HET, HET, REF, REF, HET, REF, REF, HET),
            ChromosomeType.AUTOSOMAL);
    result = checker.checkMendelianInheritance(gcList);
  ...
  public void testCasePositivesOneVariant2() throws IncompatiblePedigreeException {
    gcList =
        getGenotypeCallsList(
            lst(REF, REF, REF, HET, REF, HET, REF, REF, REF, HET, REF, REF, HET),
            ChromosomeType.AUTOSOMAL);
    result = checker.checkMendelianInheritance(gcList);
  ...
  public void testCasePositivesOneVariant3() throws IncompatiblePedigreeException {
    gcList =
        getGenotypeCallsList(
            lst(REF, REF, REF, HET, REF, HET, UKN, REF, REF, HET, REF, REF, HET),
            ChromosomeType.AUTOSOMAL);
    result = checker.checkMendelianInheritance(gcList);
