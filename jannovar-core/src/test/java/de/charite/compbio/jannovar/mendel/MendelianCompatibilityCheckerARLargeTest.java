...
public class MendelianCompatibilityCheckerARLargeTest
  ...
  public void setUp() throws Exception {
    ...
    this.names =
        ImmutableList.of(
            "I.1", "I.2", "II.1", "II.2", "II.3", "II.4", "III.1", "III.2", "IV.1", "IV.2");
  ...
  public void testCaseNegativesOneVariant1() throws IncompatiblePedigreeException {
    gcList =
        getGenotypeCallsList(
            lst(HET, HET, HET, HET, HET, HET, HET, HET, HET, HET), ChromosomeType.AUTOSOMAL);
  ...
  public void testCaseNegativesOneVariant2() throws IncompatiblePedigreeException {
    gcList =
        getGenotypeCallsList(
            lst(REF, REF, REF, REF, REF, REF, REF, REF, REF, REF), ChromosomeType.AUTOSOMAL);
    result = checker.checkMendelianInheritance(gcList);
  ...
  public void testCaseNegativesOneVariant3() throws IncompatiblePedigreeException {
    gcList =
        getGenotypeCallsList(
            lst(ALT, ALT, ALT, ALT, ALT, ALT, ALT, ALT, ALT, ALT), ChromosomeType.AUTOSOMAL);
    result = checker.checkMendelianInheritance(gcList);
  ...
  public void testCaseNegativesOneVariant4() throws IncompatiblePedigreeException {
    gcList =
        getGenotypeCallsList(
            lst(UKN, UKN, UKN, UKN, UKN, UKN, UKN, UKN, UKN, UKN), ChromosomeType.AUTOSOMAL);
    result = checker.checkMendelianInheritance(gcList);
  ...
  public void testCaseNegativesOneVariant5() throws IncompatiblePedigreeException {
    gcList =
        getGenotypeCallsList(
            lst(HET, HET, REF, HET, ALT, UKN, HET, HET, ALT, REF), ChromosomeType.AUTOSOMAL);
    result = checker.checkMendelianInheritance(gcList);
  ...
  public void testCaseNegativesOneVariant6() throws IncompatiblePedigreeException {
    ...
    gcList =
        getGenotypeCallsList(
            lst(HET, HET, REF, HET, UKN, UKN, HET, HET, UKN, REF), ChromosomeType.AUTOSOMAL);
    result = checker.checkMendelianInheritance(gcList);
  ...
  public void testCaseNegativesOneVariant7() throws IncompatiblePedigreeException {
    ...
    gcList =
        getGenotypeCallsList(
            lst(HET, HET, REF, HET, UKN, ALT, HET, HET, UKN, REF), ChromosomeType.AUTOSOMAL);
    result = checker.checkMendelianInheritance(gcList);
  ...
  public void testCasePositivesOneVariant2() throws IncompatiblePedigreeException {
    gcList =
        getGenotypeCallsList(
            lst(HET, HET, REF, HET, ALT, REF, HET, HET, ALT, REF), ChromosomeType.AUTOSOMAL);
    result = checker.checkMendelianInheritance(gcList);
  ...
  public void testCasePositivesOneVariant3() throws IncompatiblePedigreeException {
    gcList =
        getGenotypeCallsList(
            lst(HET, HET, REF, HET, ALT, ALT, HET, HET, ALT, REF), ChromosomeType.AUTOSOMAL);
    result = checker.checkMendelianInheritance(gcList);
  ...
  public void testCasePositivesOneVariant4() throws IncompatiblePedigreeException {
    gcList =
        getGenotypeCallsList(
            lst(HET, HET, REF, HET, ALT, REF, HET, HET, UKN, REF), ChromosomeType.AUTOSOMAL);
    result = checker.checkMendelianInheritance(gcList);
  ...
  public void testCasePositivesOneVariant5() throws IncompatiblePedigreeException {
    ...
    // but ChromosomeType.AUTOSOMAL inheritance from I.1/2 to II.2 (cause II.3 is alt, II.2 must be
    // het).
    gcList =
        getGenotypeCallsList(
            lst(HET, HET, HET, REF, ALT, UKN, HET, HET, ALT, REF), ChromosomeType.AUTOSOMAL);
    result = checker.checkMendelianInheritance(gcList);
  ...
  public void testCasePositivesOneVariant6() throws IncompatiblePedigreeException {
    ...
    gcList =
        getGenotypeCallsList(
            lst(HET, HET, HET, HET, ALT, UKN, HET, HET, ALT, REF), ChromosomeType.AUTOSOMAL);
    result = checker.checkMendelianInheritance(gcList);
  ...
  public void testCasePositivesOneVariant7() throws IncompatiblePedigreeException {
    ...
    gcList =
        getGenotypeCallsList(
            lst(HET, HET, REF, REF, ALT, UKN, HET, HET, ALT, REF), ChromosomeType.AUTOSOMAL);
    result = checker.checkMendelianInheritance(gcList);
  ...
  public void testCasePositivesTwoVariants1() throws IncompatiblePedigreeException {
    gcList =
        getGenotypeCallsList(
            lst(HET, REF, REF, REF, HET, UKN, REF, REF, HET, REF),
            lst(REF, HET, HET, REF, HET, UKN, HET, REF, HET, REF),
  ...
  public void testCasePositivesTwoVariants2() throws IncompatiblePedigreeException {
    gcList =
        getGenotypeCallsList(
            lst(REF, HET, REF, HET, HET, UKN, HET, HET, HET, REF),
            lst(HET, REF, REF, REF, HET, UKN, REF, REF, HET, REF),
            ChromosomeType.AUTOSOMAL);
    result = checker.checkMendelianInheritance(gcList);
