...
public class MendelianCompatibilityCheckerTestBase {
  ...
  protected List<GenotypeCalls> getGenotypeCallsList(
      ImmutableList<SimpleGenotype> genotypes, ChromosomeType chromosomeType) {
    ...
    for (int i = 0; i < names.size(); ++i) {
      switch (genotypes.get(i)) {
        ...
        case REF:
          entries.put(
              names.get(i), new Genotype(ImmutableList.of(Genotype.REF_CALL, Genotype.REF_CALL)));
          break;
        case ALT:
        ...
        case UKN:
          entries.put(
              names.get(i), new Genotype(ImmutableList.of(Genotype.NO_CALL, Genotype.NO_CALL)));
          break;
      }
    }
  ...
  protected List<GenotypeCalls> getGenotypeCallsList(
      ImmutableList<SimpleGenotype> genotypes1,
