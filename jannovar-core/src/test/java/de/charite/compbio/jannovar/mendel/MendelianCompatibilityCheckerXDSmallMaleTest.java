...
public class MendelianCompatibilityCheckerXDSmallMaleTest
  ...
  // Note that the following case are NOT considered as AD since we require the mutation to be
  // heterozygous for
  // AD.
  ...
  public void testCaseNegativesTwoVariants1() throws IncompatiblePedigreeException {
    gcList =
        getGenotypeCallsList(
            lst(REF, ALT, ALT, HET), lst(REF, UKN, ALT, ALT), ChromosomeType.X_CHROMOSOMAL);
    result = checker.checkMendelianInheritance(gcList);
  ...
  public void testCaseNegativesTwoVariants2() throws IncompatiblePedigreeException {
    gcList =
        getGenotypeCallsList(
            lst(REF, HET, ALT, ALT), lst(REF, UKN, ALT, ALT), ChromosomeType.X_CHROMOSOMAL);
    result = checker.checkMendelianInheritance(gcList);
  ...
  public void testCaseNegativesTwoVariants3() throws IncompatiblePedigreeException {
    gcList =
        getGenotypeCallsList(
            lst(REF, REF, ALT, REF), lst(REF, UKN, ALT, ALT), ChromosomeType.X_CHROMOSOMAL);
    result = checker.checkMendelianInheritance(gcList);
  ...
  public void testCaseNegativesTwoVariants4() throws IncompatiblePedigreeException {
    gcList =
        getGenotypeCallsList(
            lst(ALT, REF, ALT, REF), lst(REF, UKN, ALT, ALT), ChromosomeType.X_CHROMOSOMAL);
    result = checker.checkMendelianInheritance(gcList);
  ...
  public void testCasePositivesTwoVariants2() throws IncompatiblePedigreeException {
    gcList =
        getGenotypeCallsList(
            lst(UKN, HET, ALT, UKN), lst(ALT, ALT, ALT, ALT), ChromosomeType.X_CHROMOSOMAL);
    result = checker.checkMendelianInheritance(gcList);
  ...
  public void testCasePositivesTwoVariants3() throws IncompatiblePedigreeException {
    gcList =
        getGenotypeCallsList(
            lst(UKN, UKN, ALT, UKN), lst(UKN, UKN, ALT, UKN), ChromosomeType.X_CHROMOSOMAL);
    result = checker.checkMendelianInheritance(gcList);
  ...
  public void testCasePositivesTwoVariants4() throws IncompatiblePedigreeException {
    gcList =
        getGenotypeCallsList(
            lst(UKN, HET, UKN, UKN), lst(ALT, ALT, ALT, ALT), ChromosomeType.X_CHROMOSOMAL);
    result = checker.checkMendelianInheritance(gcList);
  ...
  public void testCasePositivesTwoVariants5() throws IncompatiblePedigreeException {
    gcList =
        getGenotypeCallsList(
            lst(REF, HET, HET, REF), lst(REF, HET, HET, REF), ChromosomeType.X_CHROMOSOMAL);
    result = checker.checkMendelianInheritance(gcList);
  ...
  public void testCasePositivesTwoVariants6() throws IncompatiblePedigreeException {
    gcList =
        getGenotypeCallsList(
            lst(UKN, HET, HET, UKN), lst(ALT, ALT, ALT, ALT), ChromosomeType.X_CHROMOSOMAL);
    result = checker.checkMendelianInheritance(gcList);
  ...
  public void testCasePositivesTwoVariants7() throws IncompatiblePedigreeException {
    gcList =
        getGenotypeCallsList(
            lst(UKN, UKN, HET, UKN), lst(UKN, UKN, HET, UKN), ChromosomeType.X_CHROMOSOMAL);
    result = checker.checkMendelianInheritance(gcList);
