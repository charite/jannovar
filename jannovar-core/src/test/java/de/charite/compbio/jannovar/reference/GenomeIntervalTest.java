...
public class GenomeIntervalTest {
  ...
  public void testConstructorDefaultPositionType() {
    GenomeInterval interval =
        new GenomeInterval(refDict, Strand.FWD, 1, 23, 45, PositionType.ONE_BASED);
  ...
  public void testConstructorExplicitPositionType() {
    GenomeInterval interval =
        new GenomeInterval(refDict, Strand.FWD, 1, 23, 45, PositionType.ZERO_BASED);
    Assert.assertEquals(interval.getChr(), 1);
  ...
  public void testGetGenomeBeginEndPosOneBased() {
    GenomeInterval interval =
        new GenomeInterval(refDict, Strand.FWD, 1, 23, 45, PositionType.ONE_BASED);
    Assert.assertEquals(
        new GenomePosition(refDict, Strand.FWD, 1, 23, PositionType.ONE_BASED),
        interval.getGenomeBeginPos());
    Assert.assertEquals(
        new GenomePosition(refDict, Strand.FWD, 1, 45, PositionType.ZERO_BASED),
  ...
  public void testGetGenomeBeginEndPosZeroBased() {
    GenomeInterval interval =
        new GenomeInterval(refDict, Strand.FWD, 1, 23, 45, PositionType.ZERO_BASED);
    Assert.assertEquals(
        new GenomePosition(refDict, Strand.FWD, 1, 23, PositionType.ZERO_BASED),
        interval.getGenomeBeginPos());
    Assert.assertEquals(
        new GenomePosition(refDict, Strand.FWD, 1, 45, PositionType.ZERO_BASED),
        interval.getGenomeEndPos());
  ...
  public void testConstructForwardToReverseOneBased() {
    GenomeInterval fwdInterval =
        new GenomeInterval(refDict, Strand.FWD, 1, 1000, 1100, PositionType.ONE_BASED);
    ...
    Assert.assertFalse(
        revInterval.contains(
            new GenomePosition(refDict, Strand.FWD, 1, 999, PositionType.ONE_BASED)));
    Assert.assertTrue(
        revInterval.contains(
            new GenomePosition(refDict, Strand.FWD, 1, 1100, PositionType.ONE_BASED)));
    Assert.assertTrue(
        revInterval.contains(
            new GenomePosition(refDict, Strand.FWD, 1, 1000, PositionType.ONE_BASED)));
    Assert.assertFalse(
        revInterval.contains(
            new GenomePosition(refDict, Strand.FWD, 1, 1101, PositionType.ONE_BASED)));
  }
  ...
  public void testConstructReverseToForwardOneBased() {
    GenomeInterval revInterval =
        new GenomeInterval(refDict, Strand.REV, 1, 1000, 1100, PositionType.ONE_BASED);
    ...
    Assert.assertFalse(
        revInterval.contains(
            new GenomePosition(refDict, Strand.REV, 1, 999, PositionType.ONE_BASED)));
    Assert.assertTrue(
        revInterval.contains(
            new GenomePosition(refDict, Strand.REV, 1, 1100, PositionType.ONE_BASED)));
    Assert.assertTrue(
        revInterval.contains(
            new GenomePosition(refDict, Strand.REV, 1, 1000, PositionType.ONE_BASED)));
    Assert.assertFalse(
        revInterval.contains(
            new GenomePosition(refDict, Strand.REV, 1, 1101, PositionType.ONE_BASED)));
  }
  ...
  public void testConstructForwardToReverseZeroBased() {
    GenomeInterval fwdInterval =
        new GenomeInterval(refDict, Strand.FWD, 1, 1000, 1100, PositionType.ZERO_BASED);
    GenomeInterval revInterval = fwdInterval.withStrand(Strand.REV);
    ...
    Assert.assertFalse(
        revInterval.contains(
            new GenomePosition(refDict, Strand.FWD, 1, 999, PositionType.ZERO_BASED)));
    Assert.assertTrue(
        revInterval.contains(
            new GenomePosition(refDict, Strand.FWD, 1, 1000, PositionType.ZERO_BASED)));
    Assert.assertTrue(
        revInterval.contains(
            new GenomePosition(refDict, Strand.FWD, 1, 1099, PositionType.ZERO_BASED)));
    Assert.assertFalse(
        revInterval.contains(
            new GenomePosition(refDict, Strand.FWD, 1, 1100, PositionType.ZERO_BASED)));
  }

  @Test
  public void testConstructReverseToForwardZeroBased() {
    GenomeInterval revInterval =
        new GenomeInterval(refDict, Strand.REV, 1, 1000, 1100, PositionType.ZERO_BASED);
    GenomeInterval fwdInterval = revInterval.withStrand(Strand.FWD);
    ...
    // check contains() after flip
    Assert.assertFalse(
        fwdInterval.contains(
            new GenomePosition(refDict, Strand.REV, 1, 999, PositionType.ZERO_BASED)));
    Assert.assertTrue(
        fwdInterval.contains(
            new GenomePosition(refDict, Strand.REV, 1, 1000, PositionType.ZERO_BASED)));
    Assert.assertTrue(
        fwdInterval.contains(
            new GenomePosition(refDict, Strand.REV, 1, 1099, PositionType.ZERO_BASED)));
    Assert.assertFalse(
        fwdInterval.contains(
            new GenomePosition(refDict, Strand.REV, 1, 1100, PositionType.ZERO_BASED)));
  }

  @Test
  public void testIsLeftOf() {
    GenomeInterval interval =
        new GenomeInterval(refDict, Strand.FWD, 1, 1000, 1200, PositionType.ONE_BASED);
    Assert.assertTrue(
        interval.isRightOf(
            new GenomePosition(refDict, Strand.FWD, 1, 999, PositionType.ONE_BASED)));
    Assert.assertFalse(
  ...
  public void testIsRightOf() {
    ...
    Assert.assertFalse(
        interval.isLeftOf(
            new GenomePosition(refDict, Strand.FWD, 1, 1200, PositionType.ONE_BASED)));
    Assert.assertTrue(
        interval.isLeftOf(
            new GenomePosition(refDict, Strand.FWD, 1, 1201, PositionType.ONE_BASED)));
  }
  ...
  public void testContainsSameChrNo() {
    GenomeInterval interval =
        new GenomeInterval(refDict, Strand.FWD, 1, 1000, 1200, PositionType.ONE_BASED);
    Assert.assertFalse(
        interval.contains(new GenomePosition(refDict, Strand.FWD, 1, 999, PositionType.ONE_BASED)));
    Assert.assertFalse(
        interval.contains(
            new GenomePosition(refDict, Strand.FWD, 1, 1201, PositionType.ONE_BASED)));
  }
  ...
  public void testContainsDifferentChr() {
    ...
    Assert.assertFalse(
        interval.contains(
            new GenomePosition(refDict, Strand.FWD, 2, 1100, PositionType.ONE_BASED)));
  }

  @Test
  public void testIntersection() {
    GenomeInterval intervalL =
        new GenomeInterval(refDict, Strand.FWD, 1, 1000, 1200, PositionType.ONE_BASED);
    GenomeInterval intervalR =
        new GenomeInterval(refDict, Strand.FWD, 1, 1100, 1300, PositionType.ONE_BASED);
    GenomeInterval intervalE =
        new GenomeInterval(refDict, Strand.FWD, 1, 1100, 1200, PositionType.ONE_BASED);
