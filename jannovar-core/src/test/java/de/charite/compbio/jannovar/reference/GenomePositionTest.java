...
public class GenomePositionTest {
  ...
  public void testDifferenceToIntervalForward() {
    ...
    GenomeInterval itv =
        new GenomeInterval(refDict, Strand.FWD, 1, 101, 200, PositionType.ONE_BASED);
  ...
  public void testDifferenceToIntervalReverse() {
    ...
    GenomeInterval itv =
        new GenomeInterval(refDict, Strand.REV, 1, 101, 200, PositionType.ONE_BASED);
