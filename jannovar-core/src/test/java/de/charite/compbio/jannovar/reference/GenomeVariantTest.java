...
public class GenomeVariantTest {
  ...
  @Before
  public void setUp() {
    this.genomePosOneBasedForward =
        new GenomePosition(refDict, Strand.FWD, 1, 123, PositionType.ONE_BASED);
    this.genomePosZeroBasedForward =
        new GenomePosition(refDict, Strand.FWD, 1, 122, PositionType.ZERO_BASED);
    this.genomePosZeroBasedReverse =
        new GenomePosition(refDict, Strand.REV, 1, 122, PositionType.ZERO_BASED);
  }
  ...
  public void testConstructorChangeStrandZeroRefBasesOneBased() {
    ...
    Assert.assertEquals(
        this.genomePosOneBasedForward.shifted(-1).withStrand(Strand.REV), change.getGenomePos());
  ...
  public void testConstructorChangeStrandOneRefBaseOneBased() {
    ...
    Assert.assertEquals(
        this.genomePosOneBasedForward.shifted(0).withStrand(Strand.REV), change.getGenomePos());
  ...
  public void testConstructorChangeStrandThreeRefBasesOneBased() {
    GenomeVariant change =
        new GenomeVariant(this.genomePosOneBasedForward, "AAA", "CCC", Strand.REV);
    Assert.assertEquals(
        this.genomePosOneBasedForward.shifted(2).withStrand(Strand.REV), change.getGenomePos());
  ...
  public void testConstructorChangeStrandZeroRefBasesZeroBased() {
    ...
    Assert.assertEquals(
        this.genomePosZeroBasedForward.shifted(-1).withStrand(Strand.REV), change.getGenomePos());
    Assert.assertEquals("", change.getRef());
    Assert.assertEquals("G", change.getAlt());
  }
  ...
  public void testConstructorChangeStrandOneRefBaseZeroBased() {
    ...
    Assert.assertEquals(
        this.genomePosZeroBasedForward.shifted(0).withStrand(Strand.REV), change.getGenomePos());
    Assert.assertEquals("T", change.getRef());
    Assert.assertEquals("G", change.getAlt());
  }
  ...
  public void testConstructorChangeStrandThreeRefBasesZeroBased() {
    GenomeVariant change =
        new GenomeVariant(this.genomePosZeroBasedForward, "AAA", "CCC", Strand.REV);
    Assert.assertEquals(
        this.genomePosZeroBasedForward.shifted(2).withStrand(Strand.REV), change.getGenomePos());
    Assert.assertEquals("TTT", change.getRef());
    Assert.assertEquals("GGG", change.getAlt());
  }
  ...
  public void testConstructorStripLeading() {
    ...
    GenomePosition expectedPos =
        new GenomePosition(
            refDict,
            this.genomePosOneBasedForward.getStrand(),
            this.genomePosOneBasedForward.getChr(),
  ...
  public void testWithStrandZeroBases() {
    GenomeVariant change =
        new GenomeVariant(this.genomePosOneBasedForward, "", "C").withStrand(Strand.REV);
  ...
  public void testWithStrandOneBase() {
    GenomeVariant change =
        new GenomeVariant(this.genomePosOneBasedForward, "A", "C").withStrand(Strand.REV);
  ...
  public void testWithStrandTwoBases() {
    GenomeVariant change =
        new GenomeVariant(this.genomePosOneBasedForward, "AA", "C").withStrand(Strand.REV);
    GenomePosition expected = this.genomePosOneBasedForward.shifted(1);
    GenomePosition actual = change.getGenomePos();
    Assert.assertEquals(expected, actual);
  ...
  public void testWithStrandThreeBases() {
    GenomeVariant change =
        new GenomeVariant(this.genomePosOneBasedForward, "AAA", "C").withStrand(Strand.REV);
  ...
  public void testGetGenomeIntervalForward() {
    ...
    GenomeInterval expectedInterval =
        new GenomeInterval(refDict, Strand.FWD, 1, 123, 123, PositionType.ONE_BASED);
  ...
  public void testGetGenomeIntervalReverse() {
    ...
    GenomeInterval genomeInterval = change.getGenomeInterval();
    GenomeInterval expectedInterval =
        new GenomeInterval(refDict, Strand.REV, 1, 122, 123, PositionType.ZERO_BASED);
    Assert.assertTrue(expectedInterval.equals(genomeInterval));
    Assert.assertEquals(expectedInterval, genomeInterval);
  }
}
