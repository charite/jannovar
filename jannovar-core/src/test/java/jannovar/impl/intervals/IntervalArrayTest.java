...
public class IntervalArrayTest {
	...
	public void testSearchPub1() {
		...
		Assert.assertEquals(1, res.values.size());
		Assert.assertEquals(new Triple(1, 4, "a"), res.values.get(0));
	}
	...
	public void testSearchPub2() throws IntervalTreeException {
		...
		Assert.assertEquals(1, res.values.size());
		Assert.assertEquals(new Triple(9, 20, "f"), res.values.get(0));
	}
	...
	public void testSearchPub3() throws IntervalTreeException {
		...
		Assert.assertEquals(new Triple(29, 34, "i"), res.values.get(0));
		Assert.assertEquals(new Triple(30, 33, "j"), res.values.get(1));
	}
	...
	public void testSearch2a() {
		...
		Assert.assertEquals(3, res.values.size());
		Assert.assertEquals(new Triple(4, 8, "c"), res.values.get(0));
		Assert.assertEquals(new Triple(5, 7, "d"), res.values.get(1));
		Assert.assertEquals(new Triple(5, 9, "b"), res.values.get(2));
	}
	...
	public void testSearch2b() {
		...
		Assert.assertEquals(1, res.values.size());
		Assert.assertEquals(new Triple(11, 16, "f"), res.values.get(0));
	}
	...
	public void testSearch100() {
		...
		Assert.assertEquals(1, res.values.size());
		Assert.assertEquals(new Triple(0, 11, "a"), res.values.get(0));
	}
	...
	public void testSearch101() {
		...
		Assert.assertEquals(1, res.values.size());
		Assert.assertEquals(new Triple(15, 36, "b"), res.values.get(0));
	}
