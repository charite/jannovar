- chr1_oma1_to_jun.ser - RefSeq snippet from chr1, including genes OMA1
  TACSTD2 MYSM1 JUN. hg19 coordinates.

```
# java -jar jannovar-cli/target/jannovar-cli-0.29-SNAPSHOT.jar \
    download \
...
# java -jar jannovar-cli/target/jannovar-cli-0.29-SNAPSHOT.jar \
    download \
    -d hg19/refseq_curated_ \
    -o jannovar-core/src/test/resources/chr19_ltbp4.ser \
    --reference-path /fast/projects/cubit/18.12/static_data/reference/GRCh37/hs37d5/hs37d5.fa \
    --gene-ids LTBP4
```
