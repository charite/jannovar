...
public class PedigreeFilterOptions {
  ...
  public PedigreeFilterOptions(
      int deNovoMaxParentAd2,
      boolean applyParentGtFilteredFilters,
  ...
  public String toString() {
    return "PedigreeFilterOptions [deNovoMaxParentAd2="
        + deNovoMaxParentAd2
        + ", applyParentGtFilteredFilters="
        + applyParentGtFilteredFilters
