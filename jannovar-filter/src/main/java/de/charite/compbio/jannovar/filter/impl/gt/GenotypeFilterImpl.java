...
/**
 * Interface for tool-specific extraction from depth of coverage, genotype quality, and alternative
 * allele fraction
 *
...
public interface GenotypeFilterImpl {
  ...
  /**
   * @return allele fraction for the given <code>alleleNo</code> (0 is reference, 1.. alternative
   *     alleles)
   */
