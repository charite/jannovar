...
public enum SupportedVarCaller {
  ...
  public static SupportedVarCaller guessFromGenotype(Genotype gt) {
    if (gt.hasAnyAttribute("DP") && gt.hasAnyAttribute("DV") && gt.hasAnyAttribute("DPR")) {
      return BCFTOOLS;
    } else if (gt.hasAnyAttribute("GT")
        && gt.hasAnyAttribute("GQ")
        && gt.hasAnyAttribute("RO")
        && gt.hasAnyAttribute("QR")
        && gt.hasAnyAttribute("AO")
        && gt.hasAnyAttribute("QA")) {
      return FREEBAYES;
    } else if (gt.hasAnyAttribute("GT")
        && gt.hasAnyAttribute("AD")
        && gt.hasAnyAttribute("DP")
        && gt.hasAnyAttribute("GQ")
        && gt.hasAnyAttribute("PL")) {
      return GATK_CALLER;
    } else if (gt.hasAnyAttribute("GT")
        && gt.hasAnyAttribute("GQ")
        && gt.hasAnyAttribute("NR")
