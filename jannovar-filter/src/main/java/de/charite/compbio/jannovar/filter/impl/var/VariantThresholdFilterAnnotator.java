...
public class VariantThresholdFilterAnnotator {
  ...
  public VariantThresholdFilterAnnotator(ThresholdFilterOptions options, List<String> affecteds) {
  ...
  public VariantContext annotateVariantContext(VariantContext vc) {
    ...
    final double gnomAdExomesAf = (gnomadExomesAfs == null) ? -1 : Collections.max(gnomadExomesAfs);
    ...
    @SuppressWarnings("unchecked")
    final ArrayList<Integer> exacHomCounts = ((ArrayList<Integer>) vc.getAttribute(exacHoms));
    ...
    @SuppressWarnings("unchecked")
    final ArrayList<Integer> g1kHomCounts = ((ArrayList<Integer>) vc.getAttribute(keyG1kHoms));
