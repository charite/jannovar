...
public class ThresholdFilterHeaderExtenderTest extends TresholdFilterTestBase {
  ...
  public void test() {
    ...
    Assert.assertNotNull(
        header.getFilterHeaderLine(ThresholdFilterHeaderExtender.FILTER_GT_MIN_COV_HOM_ALT));
    Assert.assertNotNull(
    ...
    Assert.assertNotNull(
        header.getFilterHeaderLine(ThresholdFilterHeaderExtender.FILTER_GT_MIN_AAF_HOM_ALT));
    Assert.assertNotNull(
        header.getFilterHeaderLine(ThresholdFilterHeaderExtender.FILTER_GT_MAX_AAF_HOM_REF));

    Assert.assertNotNull(
        header.getFilterHeaderLine(
