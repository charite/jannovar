 ...
 *
 * <p>Characterized by a 1-based position in the current coordinate system (e.g. CDS) with an offset
 * into the exon/intron.
 *
...
public class NucleotidePointLocation implements ConvertibleToHGVSString {
  ...
  final int offset;
  /**
   * <code>true</code> if the position if downstream of the CDS end (3' UTR), use negative {@link
   * #basePos} for 5' UTR.
   */
  ...
  public String toString() {
    return "NucleotidePointLocation [basePos="
        + basePos
        + ", offset="
        + offset
        + ", downstreamOfCDS="
