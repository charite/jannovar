...
public class NucleotideRange implements ConvertibleToHGVSString {
  ...
  public static NucleotideRange build(
      int firstPos, int firstPosOffset, int lastPos, int lastPosOffset) {
    return new NucleotideRange(
        NucleotidePointLocation.buildWithOffset(firstPos, firstPosOffset),
