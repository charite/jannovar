...
public class NucleotideIndel extends NucleotideChange {
  ...
  public static NucleotideIndel buildWithOffsetWithoutSeqDescription(
  ...
  public static NucleotideIndel buildWithOffsetWithLength(
    ...
    return new NucleotideIndel(
        onlyPredicted,
        NucleotideRange.build(firstPos, firstOffset, lastPos, lastOffset),
        new NucleotideSeqDescription(deletedLength),
        new NucleotideSeqDescription(insertedLength));
  }

  /** Build with sequence information */
  public static NucleotideIndel buildWithOffsetWithSequence(
      boolean onlyPredicted,
      int firstPos,
      int firstOffset,
      int lastPos,
    ...
    return new NucleotideIndel(
        onlyPredicted,
        NucleotideRange.build(firstPos, firstOffset, lastPos, lastOffset),
        new NucleotideSeqDescription(deletedSeq),
        new NucleotideSeqDescription(insertedSeq));
  }

  /** Build with sequence description */
  public static NucleotideIndel buildWithOffsetWithSeqDescription(
      boolean onlyPredicted,
      int firstPos,
      int firstOffset,
      int lastPos,
  ...
  public static NucleotideIndel buildWithoutSeqDescription(
  ...
  public static NucleotideIndel buildWithLength(
      boolean onlyPredicted, int firstPos, int lastPos, int deletedLength, int insertedLength) {
    return new NucleotideIndel(
        onlyPredicted,
        NucleotideRange.buildWithoutOffset(firstPos, lastPos),
        new NucleotideSeqDescription(deletedLength),
  ...
  public static NucleotideIndel buildWithSequence(
      boolean onlyPredicted, int firstPos, int lastPos, String deletedSeq, String insertedSeq) {
    return new NucleotideIndel(
        onlyPredicted,
        NucleotideRange.buildWithoutOffset(firstPos, lastPos),
        new NucleotideSeqDescription(deletedSeq),
  ...
  public static NucleotideIndel buildWithSeqDescription(
      boolean onlyPredicted,
      int firstPos,
      int lastPos,
      NucleotideSeqDescription delDesc,
      NucleotideSeqDescription insDesc) {
    return new NucleotideIndel(
        onlyPredicted, NucleotideRange.buildWithoutOffset(firstPos, lastPos), delDesc, insDesc);
  }

  public NucleotideIndel(
      boolean onlyPredicted,
