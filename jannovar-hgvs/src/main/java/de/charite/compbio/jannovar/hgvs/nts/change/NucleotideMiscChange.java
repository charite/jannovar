...
public class NucleotideMiscChange extends NucleotideChange {
  ...
  /**
   * Static factory function that forwards to {@link #NucleotideMiscChange(boolean,
   ...
   */
  public static NucleotideMiscChange build(
      boolean onlyPredicted, NucleotideMiscChangeType changeType) {
