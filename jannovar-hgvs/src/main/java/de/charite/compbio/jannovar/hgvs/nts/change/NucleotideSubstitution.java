...
public class NucleotideSubstitution extends NucleotideChange {
  ...
  public static NucleotideSubstitution buildWithOffset(
      boolean onlyPredicted, int basePos, int posOffset, String fromNT, String toNT) {
    return new NucleotideSubstitution(
        onlyPredicted, NucleotidePointLocation.buildWithOffset(basePos, posOffset), fromNT, toNT);
  }

  /** Build {@link NucleotideSubstitution} with nucleotide positions without offset values. */
  public static NucleotideSubstitution build(
      boolean onlyPredicted, int basePos, String fromNT, String toNT) {
    return new NucleotideSubstitution(
        onlyPredicted, NucleotidePointLocation.build(basePos), fromNT, toNT);
  }

  /** Construct with the given values */
  public NucleotideSubstitution(
      boolean onlyPredicted, NucleotidePointLocation position, String fromNT, String toNT) {
    super(onlyPredicted);
  ...
  public String toString() {
    return "NucleotideSubstitution [position="
        + position
        + ", fromNT="
        + fromNT
        + ", toNT="
