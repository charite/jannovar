...
public class MultiAlleleNucleotideVariant extends NucleotideVariant {
  ...
  public static MultiAlleleNucleotideVariant build(
      SequenceType seqType, String seqID, NucleotideChangeAllele... alleles) {
    return new MultiAlleleNucleotideVariant(seqType, seqID, ImmutableList.copyOf(alleles));
  }

  /**
   * Construct with the given {@link SequenceType}, reference/transcript ID, protein ID, transcript
   * version, and collection of {@link NucleotideChangeAllele}s.
   */
  public MultiAlleleNucleotideVariant(
  ...
  /**
   * Construct with the given {@link SequenceType}, reference/transcript ID and collection of {@link
   * NucleotideChangeAllele}s.
   */
  public MultiAlleleNucleotideVariant(
      SequenceType seqType, String seqID, Collection<NucleotideChangeAllele> alleles) {
    super(seqType, seqID);
    this.alleles = ImmutableList.copyOf(alleles);
  }
