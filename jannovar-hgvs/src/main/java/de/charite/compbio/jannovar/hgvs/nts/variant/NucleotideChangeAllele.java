 ...
 */
public final class NucleotideChangeAllele
    implements ConvertibleToHGVSString, List<NucleotideChange> {
  ...
  public static NucleotideChangeAllele build(
   ...
   */
  public NucleotideChangeAllele(
      VariantConfiguration varConfig, Collection<? extends NucleotideChange> changes) {
