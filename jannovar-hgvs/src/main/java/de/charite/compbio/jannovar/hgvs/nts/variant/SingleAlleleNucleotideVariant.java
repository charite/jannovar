...
public class SingleAlleleNucleotideVariant extends NucleotideVariant {
  ...
  public static SingleAlleleNucleotideVariant makeSingleChangeVariant(
      SequenceType seqType, String seqID, NucleotideChange change) {
    return new SingleAlleleNucleotideVariant(
        seqType, seqID, VariantConfiguration.IN_CIS, ImmutableList.of(change));
  }

  /**
   * @return single-change {@link SingleAlleleNucleotideVariant} with the given {@link
   *     SequenceType}, reference/transcript ID, and {@link VariantConfiguration}
   */
  public static SingleAlleleNucleotideVariant build(
      SequenceType seqType,
      String seqID,
      VariantConfiguration varConfig,
      NucleotideChange... changes) {
    return new SingleAlleleNucleotideVariant(
        seqType, seqID, varConfig, ImmutableList.copyOf(changes));
  }
   ...
   */
  public SingleAlleleNucleotideVariant(
      SequenceType seqType,
      String seqID,
      VariantConfiguration varConfig,
   ...
   */
  public SingleAlleleNucleotideVariant(
      SequenceType seqType, String seqID, NucleotideChangeAllele allele) {
    super(seqType, seqID);
    this.allele = allele;
  }
