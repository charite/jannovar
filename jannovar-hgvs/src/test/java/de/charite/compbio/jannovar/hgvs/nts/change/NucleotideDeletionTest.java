...
public class NucleotideDeletionTest {
  ...
  public void testLengthOneWithDeletedSeq() {
    NucleotideDeletion del =
        NucleotideDeletion.buildWithOffsetWithSequence(true, 123, 0, 123, 0, "A");
  ...
  public void testLengthOneWithBlankDeletedSeqSpec() {
    NucleotideDeletion del =
        NucleotideDeletion.buildWithOffsetWithoutSeqDescription(true, 123, 0, 123, 0);
  ...
  public void testLengthTwoWithDeletedSeq() {
    NucleotideDeletion del =
        NucleotideDeletion.buildWithOffsetWithSequence(true, 123, 0, 124, 0, "AC");
