...
public class NucleotideDuplicationTest {
  ...
  public void testLengthOneWithDuplicatedSeq() {
    NucleotideDuplication del =
        NucleotideDuplication.buildWithOffsetWithSequence(true, 123, 1, 123, 1, "A");
  ...
  public void testLengthOneWithDuplicatedSeqLength() {
    NucleotideDuplication del =
        NucleotideDuplication.buildWithOffsetWithLength(true, 123, 0, 123, 0, 1);
  ...
  public void testLengthOneWithBlankDuplicatedSeqSpec() {
    NucleotideDuplication del =
        NucleotideDuplication.buildWithOffsetWithoutSeqDescription(true, 123, 0, 123, 0);
  ...
  public void testLengthTwoWithDuplicatedSeq() {
    NucleotideDuplication del =
        NucleotideDuplication.buildWithOffsetWithSequence(true, 123, 0, 124, 0, "AC");
  ...
  public void testLengthTwoWithDuplicatedSeqLength() {
    NucleotideDuplication del =
        NucleotideDuplication.buildWithOffsetWithLength(true, 123, 0, 124, 0, 2);
