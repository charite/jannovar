...
public class NucleotideIndelTest {
  ...
  public void testWithSequenceDescription() {
    NucleotideIndel del =
        NucleotideIndel.buildWithOffsetWithSequence(true, 123, 0, 123, 0, "A", "CT");
  ...
  public void testWithBlankDescription() {
    NucleotideIndel del =
        NucleotideIndel.buildWithOffsetWithoutSeqDescription(true, 123, 0, 123, 0);
  ...
  public void testWithNucleotideSeqDescription() {
    NucleotideIndel del =
        NucleotideIndel.buildWithOffsetWithSeqDescription(
            true,
            123,
            0,
            125,
            ...
            new NucleotideSeqDescription("AC"));
