...
public class NucleotideInsertionTest {
  ...
  public void testLengthOneWithInsertedSeq() {
    NucleotideInsertion del =
        NucleotideInsertion.buildWithOffsetWithSequence(true, 123, 0, 124, 0, "CGA");
  ...
  public void testLengthOneWithInsertedSeqLength() {
    NucleotideInsertion del =
        NucleotideInsertion.buildWithOffsetWithLength(true, 123, 0, 124, 0, 1);
  ...
  public void testLengthOneWithBlankInsertedSeqSpec() {
    NucleotideInsertion del =
        NucleotideInsertion.buildWithOffsetWithLength(true, 123, 0, 124, 0, 3);
  ...
  public void testLengthTwoWithInsertedSeq() {
    NucleotideInsertion del =
        NucleotideInsertion.buildWithOffsetWithSequence(true, 123, 0, 124, 0, "AC");
  ...
  public void testLengthTwoWithInsertedSeqLength() {
    NucleotideInsertion del =
        NucleotideInsertion.buildWithOffsetWithLength(true, 123, 0, 124, 0, 2);
