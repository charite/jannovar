...
public class NucleotideInversionTest {
  ...
  public void testLengthTwoWithInvertedSeq() {
    NucleotideInversion inv =
        NucleotideInversion.buildWithOffsetWithSequence(true, 123, 0, 124, 0, "CGA");
  ...
  public void testLengthTwoWithInvertedSeqLength() {
    NucleotideInversion inv =
        NucleotideInversion.buildWithOffsetWithLength(true, 123, 0, 124, 0, 3);
  ...
  public void testLengthTwoWithBlankInvertedSeqSpec() {
    NucleotideInversion inv =
        NucleotideInversion.buildWithOffsetWithoutSeqDescription(true, 123, 0, 125, 0);
