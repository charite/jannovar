...
public class NucleotideSubstitutionTest {
  ...
  public void setUp() {
    subWithOffset =
        new NucleotideSubstitution(true, new NucleotidePointLocation(10, 1, false), "A", "T");
    subWithoutOffset =
        new NucleotideSubstitution(true, new NucleotidePointLocation(10, 0, false), "A", "T");
  }

  @Test
  public void testBuildWithOffset() {
    Assert.assertEquals(
        subWithOffset, NucleotideSubstitution.buildWithOffset(true, 10, 1, "A", "T"));
  }

  @Test
  public void testBuildWithoutOffset() {
    Assert.assertEquals(
        subWithoutOffset, NucleotideSubstitution.buildWithOffset(true, 10, 0, "A", "T"));
  }
