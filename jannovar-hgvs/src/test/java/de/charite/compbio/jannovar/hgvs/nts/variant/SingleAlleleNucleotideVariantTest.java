...
public class SingleAlleleNucleotideVariantTest {
  ...
  public void setUp() throws Exception {
    singleChangeVariant =
        new SingleAlleleNucleotideVariant(
            ...
            ImmutableList.of(NucleotideSubstitution.build(false, 99, "A", "G")));
    multiChangeVariant =
        new SingleAlleleNucleotideVariant(
            SequenceType.CODING_DNA,
            "REF",
  ...
  public void testToHGVSStringSingleChange() {
    ...
    Assert.assertEquals(
        "REF:c.100A>G", singleChangeVariant.toHGVSString(AminoAcidCode.THREE_LETTER));
  ...
  public void testToHGVSStringMultiChange() {
    Assert.assertEquals(
        "REF:c.[100C>T;301A>G]", multiChangeVariant.toHGVSString(AminoAcidCode.ONE_LETTER));
    Assert.assertEquals(
        "REF:c.[100C>T;301A>G]", multiChangeVariant.toHGVSString(AminoAcidCode.THREE_LETTER));
