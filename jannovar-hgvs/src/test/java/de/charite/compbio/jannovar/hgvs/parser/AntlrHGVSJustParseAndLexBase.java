...
public class AntlrHGVSJustParseAndLexBase {
  ...
  public static String[] NT_STRINGS = {
    "c.3delG",
    "c.76_78del",
    "c.76_78delACT",
    "c.5_7del",
  ...
  public static String[] LEGACY_STRINGS = {
    "IVS3+3G>T",
    "IVS3-3G>T",
    "E3+3G>T",
    "E3-3G>T",
  ...
  public static String[] PROTEIN_STRINGS = {
    "p.Gly2L",
    "p.G2L",
    "p.G2L",
    "p.Glu124Serfs*148",
    "p.Gln16dup",
    "p.E124Sfs*148",
    "p.Gln3_Leu7delinsGlnGlnTrpSerLeu",
    "p.Q3_L7delinsGlnGlnTrpSerLeu",
    "p.Met1Leu",
    "p.Met1?",
    "p.M1?",
    "p.[(Ala25Thr)(;)(Pro323Leu)]",
    "p.Arg83=", /* "p.[Arg83=/Arg83Ser]", */
    /* "p.[Arg83=//Arg83Ser]", */ "p.[Ala25Thr(;)Pro323Leu]",
    "p.[(Ala25Thr)(;)(Pro323Leu)]",
    "p.[(Ala25Thr(;)Pro323Leu)]",
