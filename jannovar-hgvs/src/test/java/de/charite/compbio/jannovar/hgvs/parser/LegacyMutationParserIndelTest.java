...
public class LegacyMutationParserIndelTest {
  ...
  public void testIntronic() {
    String legacyVariantStrings[] =
        new String[] {
          "XXX:IVS3+3delins", "XXX:IVS3-3delACinsT", "XXX:IVS3-3delCATAinsTCT", "XXX:IVS3-3del4ins3"
        };
  ...
  public void testExonic() {
    String legacyVariantStrings[] =
        new String[] {
          "XXX:EX3+3delins", "XXX:EX3-3delACinsT", "XXX:EX3-3delCATAinsTCT", "XXX:EX3-3del4ins3"
        };
