...
public class HGVSParserNucleotideDeletionTest extends HGVSParserTestBase {
  ...
  public void testWithPositionWithoutDeletedString() {
    Antlr4HGVSParser parser =
        buildParserForString("123del", Antlr4HGVSLexer.NUCLEOTIDE_CHANGE, false);
    Nt_change_deletionContext nt_change_deletion = parser.nt_change_deletion();
    Assert.assertEquals(
        "(nt_change_deletion (nt_point_location (nt_base_location (nt_number 123))) del)",
  ...
  public void testWithPositionWithDeletedLength() {
    Antlr4HGVSParser parser =
        buildParserForString("123del1", Antlr4HGVSLexer.NUCLEOTIDE_CHANGE, false);
    Nt_change_deletionContext nt_change_deletion = parser.nt_change_deletion();
    Assert.assertEquals(
  ...
  public void testWithPositionWithDeletedString() {
    Antlr4HGVSParser parser =
        buildParserForString("123delTA", Antlr4HGVSLexer.NUCLEOTIDE_CHANGE, false);
    Nt_change_deletionContext nt_change_deletion = parser.nt_change_deletion();
    Assert.assertEquals(
  ...
  public void testWithRangeWithDeletedString() {
    Antlr4HGVSParser parser =
        buildParserForString("123_124delAT", Antlr4HGVSLexer.NUCLEOTIDE_CHANGE, false);
    Nt_change_deletionContext nt_change_deletion = parser.nt_change_deletion();
    Assert.assertEquals(
  ...
  public void testWithRangeWithDeletedLength() {
    Antlr4HGVSParser parser =
        buildParserForString("123_124del2", Antlr4HGVSLexer.NUCLEOTIDE_CHANGE, false);
    Nt_change_deletionContext nt_change_deletion = parser.nt_change_deletion();
    Assert.assertEquals(
  ...
  public void testWithRangeWithoutDeletedString() {
    Antlr4HGVSParser parser =
        buildParserForString("123_124del", Antlr4HGVSLexer.NUCLEOTIDE_CHANGE, false);
    Nt_change_deletionContext nt_change_deletion = parser.nt_change_deletion();
    Assert.assertEquals(
