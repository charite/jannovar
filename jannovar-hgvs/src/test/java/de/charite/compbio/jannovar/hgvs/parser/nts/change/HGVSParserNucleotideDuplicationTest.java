...
public class HGVSParserNucleotideDuplicationTest extends HGVSParserTestBase {
  ...
  public void testWithPositionWithDuplicatedString() {
    Antlr4HGVSParser parser =
        buildParserForString("123dup", Antlr4HGVSLexer.NUCLEOTIDE_CHANGE, false);
    Nt_change_duplicationContext nt_change_duplication = parser.nt_change_duplication();
    Assert.assertEquals(
        "(nt_change_duplication (nt_point_location (nt_base_location (nt_number 123))) dup)",
  ...
  public void testWithPositionWithDuplicatedLength() {
    Antlr4HGVSParser parser =
        buildParserForString("123dup1", Antlr4HGVSLexer.NUCLEOTIDE_CHANGE, false);
    Nt_change_duplicationContext nt_change_duplication = parser.nt_change_duplication();
    Assert.assertEquals(
  ...
  public void testWithPositionWithoutDuplicatedString() {
    Antlr4HGVSParser parser =
        buildParserForString("123dupTA", Antlr4HGVSLexer.NUCLEOTIDE_CHANGE, false);
  ...
  public void testWithRangeWithDuplicatedString() {
    Antlr4HGVSParser parser =
        buildParserForString("123_124dupAT", Antlr4HGVSLexer.NUCLEOTIDE_CHANGE, false);
    Nt_change_duplicationContext nt_change_duplication = parser.nt_change_duplication();
    Assert.assertEquals(
  ...
  public void testWithRangeWithDuplicatedLength() {
    Antlr4HGVSParser parser =
        buildParserForString("123_124dup2", Antlr4HGVSLexer.NUCLEOTIDE_CHANGE, false);
    Nt_change_duplicationContext nt_change_duplication = parser.nt_change_duplication();
    Assert.assertEquals(
  ...
  public void testWithRangeWithoutDuplicatedString() {
    Antlr4HGVSParser parser =
        buildParserForString("123_124dup", Antlr4HGVSLexer.NUCLEOTIDE_CHANGE, false);
    Nt_change_duplicationContext nt_change_duplication = parser.nt_change_duplication();
    Assert.assertEquals(
