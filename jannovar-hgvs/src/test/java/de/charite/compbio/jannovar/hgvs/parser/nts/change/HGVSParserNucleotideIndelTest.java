...
public class HGVSParserNucleotideIndelTest extends HGVSParserTestBase {
  ...
  public void testWithPositionWithStrings() {
    Antlr4HGVSParser parser =
        buildParserForString("123delCinsTCG", Antlr4HGVSLexer.NUCLEOTIDE_CHANGE, false);
  ...
  public void testWithPositionWithLengths() {
    Antlr4HGVSParser parser =
        buildParserForString("123del1ins23", Antlr4HGVSLexer.NUCLEOTIDE_CHANGE, false);
    Nt_change_indelContext nt_change_indel = parser.nt_change_indel();
    Assert.assertEquals(
  ...
  public void testWithPositionWithoutStrings() {
    Antlr4HGVSParser parser =
        buildParserForString("123delins", Antlr4HGVSLexer.NUCLEOTIDE_CHANGE, false);
    Nt_change_indelContext nt_change_indel = parser.nt_change_indel();
    Assert.assertEquals(
        "(nt_change_indel (nt_point_location (nt_base_location (nt_number 123))) del ins)",
        nt_change_indel.toStringTree(parser));
  }
  ...
  public void testWithRangeWithStrings() {
    Antlr4HGVSParser parser =
        buildParserForString("123_124delATinsGGTAT", Antlr4HGVSLexer.NUCLEOTIDE_CHANGE, false);
    Nt_change_indelContext nt_change_indel = parser.nt_change_indel();
    Assert.assertEquals(
  ...
  public void testWithRangeWithLengths() {
    Antlr4HGVSParser parser =
        buildParserForString("123_124del2ins4", Antlr4HGVSLexer.NUCLEOTIDE_CHANGE, false);
    Nt_change_indelContext nt_change_indel = parser.nt_change_indel();
    Assert.assertEquals(
  ...
  public void testWithRangeWithoutStrings() {
    Antlr4HGVSParser parser =
        buildParserForString("123_124delins", Antlr4HGVSLexer.NUCLEOTIDE_CHANGE, false);
    Nt_change_indelContext nt_change_indel = parser.nt_change_indel();
    Assert.assertEquals(
