...
public class HGVSParserNucleotideInsertionTest extends HGVSParserTestBase {
  ...
  public void testWithRangeWithInsertedString() {
    Antlr4HGVSParser parser =
        buildParserForString("123_124insAT", Antlr4HGVSLexer.NUCLEOTIDE_CHANGE, false);
  ...
  public void testWithRangeWithInsertedLength() {
    Antlr4HGVSParser parser =
        buildParserForString("123_124ins2", Antlr4HGVSLexer.NUCLEOTIDE_CHANGE, false);
    Nt_change_insertionContext nt_change_insertion = parser.nt_change_insertion();
    Assert.assertEquals(
  ...
  public void testWithRangeWithoutInsertString() {
    Antlr4HGVSParser parser =
        buildParserForString("123_124ins", Antlr4HGVSLexer.NUCLEOTIDE_CHANGE, false);
    Nt_change_insertionContext nt_change_insertion = parser.nt_change_insertion();
    Assert.assertEquals(
