...
public class HGVSParserNucleotideInversionTest extends HGVSParserTestBase {
  ...
  public void testWithRangeWithDeletedString() {
    Antlr4HGVSParser parser =
        buildParserForString("123_124invAT", Antlr4HGVSLexer.NUCLEOTIDE_CHANGE, false);
  ...
  public void testWithRangeWithDeletedLength() {
    Antlr4HGVSParser parser =
        buildParserForString("123_124inv2", Antlr4HGVSLexer.NUCLEOTIDE_CHANGE, false);
    Nt_change_inversionContext nt_change_inversion = parser.nt_change_inversion();
    Assert.assertEquals(
  ...
  public void testWithRangeWithoutDeletedString() {
    Antlr4HGVSParser parser =
        buildParserForString("123_124inv", Antlr4HGVSLexer.NUCLEOTIDE_CHANGE, false);
    Nt_change_inversionContext nt_change_inversion = parser.nt_change_inversion();
    Assert.assertEquals(
