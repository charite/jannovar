...
public class HGVSParserNucleotideSubstitutionTest extends HGVSParserTestBase {
	...
	public void testSameAsDNA() {
		...
		Assertions.assertEquals("(nt_change_misc ( ? ))", nt_change_misc.toStringTree(parser));
	}
	...
	public void testSplicingAffected() {
		...
		Nt_change_miscContext nt_change_misc = parser.nt_change_misc();
		Assertions.assertEquals("(nt_change_misc spl ?)", nt_change_misc.toStringTree(parser));
	}
	...
	public void testNoRNA() {
		...
		Nt_change_miscContext nt_change_misc = parser.nt_change_misc();
		Assertions.assertEquals("(nt_change_misc 0)", nt_change_misc.toStringTree(parser));
	}
