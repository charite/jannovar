...
public class NucleotideChangeToGenomeVariantTranslationImplBase {
  ...
  protected static final Logger LOGGER =
      LoggerFactory.getLogger(NucleotideChangeToGenomeVariantTranslationImplBase.class);
  ...
  public NucleotideChangeToGenomeVariantTranslationImplBase(
   ...
   *
   * <p>The sequence will be reverse-complemented depending on <code>strand</code> and converted to
   * upper case.
   *
   * @param strand to load from
   * @param gItv {@link GenomeInterval} to load sequence for
