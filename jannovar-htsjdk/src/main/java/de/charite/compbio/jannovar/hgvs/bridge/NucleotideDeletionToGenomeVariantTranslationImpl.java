 ...
 */
class NucleotideDeletionToGenomeVariantTranslationImpl
    extends NucleotideChangeToGenomeVariantTranslationImplBase {

  public NucleotideDeletionToGenomeVariantTranslationImpl(
   ...
   * @param ntDel {@link NucleotideDeletion} to convert
  ...
  public ResultWithWarnings<GenomeVariant> run(
      TranscriptModel tm, SequenceType sequenceType, NucleotideDeletion ntDel)
