...
class NucleotideInsertionToGenomeVariantTranslationImpl
  ...
  public NucleotideInsertionToGenomeVariantTranslationImpl(
   ...
   * @param ntIns {@link NucleotideInsertion} to convert
  ...
  public ResultWithWarnings<GenomeVariant> run(
      TranscriptModel tm, SequenceType sequenceType, NucleotideInsertion ntIns)
    ...
    final GenomeVariant result =
        new GenomeVariant(
                gItv.withStrand(tm.getStrand()).getGenomeBeginPos().shifted(1),
                "",
