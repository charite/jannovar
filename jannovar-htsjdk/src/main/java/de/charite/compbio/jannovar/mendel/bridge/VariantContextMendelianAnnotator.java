...
public class VariantContextMendelianAnnotator {
	 ...
	 * inheritance
	 *
	 * @param vc {@link VariantContext} to check for compatibility and to
	 *           annotate
	 * @return Copy of <code>vc</code> with mendelian inheritance compatibility
	 * annotation
	 * @throws CannotAnnotateMendelianInheritance on problems with annotating the {@link VariantContext}
	 */
	 ...
	 * <code>vcs</code>
	 * @throws CannotAnnotateMendelianInheritance on problems with annotating the {@link VariantContext}s
	 */
