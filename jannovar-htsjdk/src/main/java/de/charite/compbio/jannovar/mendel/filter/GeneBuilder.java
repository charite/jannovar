...
class GeneBuilder {
  ...
  private final ImmutableList.Builder<TranscriptModel> builder =
      new ImmutableList.Builder<TranscriptModel>();
  ...
  public void addTranscriptModel(TranscriptModel tm) {
    ...
    // Transcript must be within 10kbp of a previously seen one. Otherwise, we get too large genes
    // from RNA
    // transcript matches.
