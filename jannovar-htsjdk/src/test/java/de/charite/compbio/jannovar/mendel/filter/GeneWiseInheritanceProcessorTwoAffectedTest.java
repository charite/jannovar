 ...
 *
 * <p>This test case uses one trio for the test
 *
 * @author <a href="mailto:manuel.holtgrewe@bihealth.de">Manuel Holtgrewe</a>
 */
public class GeneWiseInheritanceProcessorTwoAffectedTest {

  static final String KEY = MendelVCFHeaderExtender.key();
  static final String KEY_SUB = MendelVCFHeaderExtender.keySub();
  ...
  public void setUp() throws PedParseException {
    ...
    individuals.add(
        new PedPerson("ped", "Eva", "0", "0", Sex.FEMALE, Disease.UNAFFECTED)); // Mother
    individuals.add(new PedPerson("ped", "Adam", "0", "0", Sex.MALE, Disease.AFFECTED)); // Father
    individuals.add(
        new PedPerson("ped", "Seth", "Adam", "Eva", Sex.MALE, Disease.AFFECTED)); // Child
