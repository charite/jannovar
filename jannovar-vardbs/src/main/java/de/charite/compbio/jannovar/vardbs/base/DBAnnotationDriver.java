...
public interface DBAnnotationDriver {
   ...
   *
   * <p>Note that the annotation in jannovar-vardbs makes a distinction between variants that are in
   * the database and variants that are only at the same position or overlap.
   *
