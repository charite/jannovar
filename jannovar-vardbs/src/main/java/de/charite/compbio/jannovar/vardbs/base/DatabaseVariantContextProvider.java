...
/**
 * Allow to query database with contig, (1-based) begin, and end position to produce a {@link
 * VariantContext} with annotating information.
 *
...
public interface DatabaseVariantContextProvider {
   ...
   *
   * @param contig Name of the contig to perform query on.
   * @param beginPos 1-based start position
