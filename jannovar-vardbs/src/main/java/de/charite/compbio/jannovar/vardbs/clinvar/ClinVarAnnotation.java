 ...
 *
 * <p>One allele can have multiple annotations.
 *
...
public class ClinVarAnnotation {
  ...
  public ClinVarAnnotation(
      String hgvsVariant,
      int alleleMapping,
      Collection<ClinVarSourceInfo> sourceInfos,
      Collection<ClinVarOrigin> origin,
      Collection<ClinVarDiseaseInfo> diseaseInfos) {
    super();
  ...
  public String toString() {
    return "ClinVarAnnotation [alleleMapping="
        + alleleMapping
        + ", hgvsVariant="
        + hgvsVariant
        + ", sourceInfos="
