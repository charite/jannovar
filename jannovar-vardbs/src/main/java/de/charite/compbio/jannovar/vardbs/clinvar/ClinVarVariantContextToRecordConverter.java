 ...
 */
final class ClinVarVariantContextToRecordConverter
  ...
  public ClinVarRecord convert(VariantContext vc) {
    ...
    for (int idx = 0; idx < alleles.size(); ++idx) {
      ...
      ArrayList<String> clnOriginList =
          Lists.newArrayList(((String) clnOrigin.get(idx)).split("\\|"));

      // Variant source information: CLNSRC, CLNSRCID
      ArrayList<String> clnSrcList = Lists.newArrayList(((String) clnSrc.get(idx)).split("\\|"));
      ArrayList<String> clnSrcIdList =
          Lists.newArrayList(((String) clnSrcId.get(idx)).split("\\|"));
      ...
      ArrayList<String> clnDiseaseDbList =
          Lists.newArrayList(((String) clnDiseaseDb.get(idx)).split("\\|"));
      ArrayList<String> clnDiseaseDbIdList =
          Lists.newArrayList(((String) clnDiseaseDbId.get(idx)).split("\\|"));
      ArrayList<String> clnDiseaseDbNameList =
          Lists.newArrayList(((String) clnDiseaseDbName.get(idx)).split("\\|"));
      ArrayList<String> clnRevStatList =
          Lists.newArrayList(((String) clnRevStat.get(idx)).split("\\|"));
      ArrayList<String> clnAccessionList =
          Lists.newArrayList(((String) clnAccession.get(idx)).split("\\|"));
      ...
      int numDiseaseAlleles =
          Collections.max(
              ImmutableList.of(
                  clnSigList.size(),
                  clnDiseaseDbList.size(),
                  clnDiseaseDbIdList.size(),
        ...
        diseaseInfos.add(
            new ClinVarDiseaseInfo(
                ClinVarSignificance.fromInteger(
                    Integer.parseInt(getFromList(clnSigList, i, "255"))),
                getFromList(clnDiseaseDbList, i, ""),
