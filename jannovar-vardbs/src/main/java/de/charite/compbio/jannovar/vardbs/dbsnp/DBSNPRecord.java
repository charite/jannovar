 ...
 * An entry in dbSNP
 *
 * <p>Note that as with all databases, the annotation is for actual variants and not just positions.
 *
...
public final class DBSNPRecord {
  ...
  /**
   * Alternative frequencies as seen in 1000 Genomes project, entry with index 0 is the first
   * alternative allele
   */
  final ImmutableList<Double> alleleFrequenciesG1K;
  /**
   * Is a common SNP (>=1% in at least one 1000 genomes population with at least 2 founders
   * contributing)
   */
  ...
  public DBSNPRecord(
      ...
      String id,
      String ref,
      Collection<String> alt,
      Collection<String> filter,
      int rsID,
      int rsPos,
      boolean reversed,
      DBSNPVariantProperty variantProperty,
      Collection<DBSNPGeneInfo> geneInfos,
      int dbSNPBuildID,
      DBSNPVariantAlleleOrigin variantAlleleOrigin,
      Collection<DBSNPVariantSuspectReasonCode> variantSuspectReasonCode,
      int weights,
      ...
      Collection<Double> alleleFrequenciesG1K,
      boolean common,
      Collection<String> oldVariants) {
    this.chrom = chrom;
    this.pos = pos;
    this.id = id;
    this.ref = ref;
  ...
  public int hashCode() {
    ...
    int result = 1;
    result =
        prime * result + ((alleleFrequenciesG1K == null) ? 0 : alleleFrequenciesG1K.hashCode());
    ...
    result =
        prime * result
            + ((variantSuspectReasonCode == null) ? 0 : variantSuspectReasonCode.hashCode());
  ...
  public String toString() {
    return "DBSNPRecord [chrom="
        ...
        + nonSynonymousFrameShift
        + ", nonSynonymousMissense="
        + nonSynonymousMissense
        + ", nonSynonymousNonsense="
        + nonSynonymousNonsense
        + ", reference="
        + reference
        + ", synonymous="
        ...
        + clinicalDiagnosticAssay
        + ", locusSpecificDatabase="
        + locusSpecificDatabase
        + ", microattributionThirdParty="
        + microattributionThirdParty
        + ", hasOMIMOrOMIA="
        + hasOMIMOrOMIA
        + ", contigAlelleNotVariant="
        + contigAlelleNotVariant
        + ", withdrawn="
        + withdrawn
        + ", nonOverlappingAlleleSet="
        + nonOverlappingAlleleSet
        + ", alleleFrequenciesG1K="
        + alleleFrequenciesG1K
        + ", common="
        + common
        + ", oldVariants="
