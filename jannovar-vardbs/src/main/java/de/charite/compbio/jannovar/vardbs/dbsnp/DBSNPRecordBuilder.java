...
public class DBSNPRecordBuilder {
  ...
  /**
   * Allele frequencies as seen in 1000 Genomes project, entry with index 0 is from reference, the
   * others are (in the same order) the frequencies for the alternative alleles.
   */
  ...
  public void setVariantSuspectReasonCode(
      HashSet<DBSNPVariantSuspectReasonCode> variantSuspectReasonCode) {
