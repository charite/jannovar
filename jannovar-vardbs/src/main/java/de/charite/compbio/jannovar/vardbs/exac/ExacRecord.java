...
public class ExacRecord {
  ...
  public ExacRecord(
      ...
      Map<ExacPopulation, List<Integer>> alleleHetCounts,
      Map<ExacPopulation, List<Integer>> alleleHomCounts,
      Map<ExacPopulation, List<Integer>> alleleHemiCounts,
    ...
    ImmutableSortedMap.Builder<ExacPopulation, ImmutableList<Double>> afBuilder =
        ImmutableSortedMap.naturalOrder();
  ...
  /**
   * @return {@link ExacPopulation} with highest allele frequency for the given allele index (0 is
