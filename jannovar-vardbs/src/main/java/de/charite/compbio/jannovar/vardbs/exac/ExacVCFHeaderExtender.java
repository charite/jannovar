...
public class ExacVCFHeaderExtender extends VCFHeaderExtender {
  ...
  private void addBestAFHeader(VCFHeader header, String prefix, String idInfix, String noteInfix) {
    VCFInfoHeaderLine line =
        new VCFInfoHeaderLine(
            prefix + idInfix + "AF_POPMAX",
            VCFHeaderLineCount.A,
            VCFHeaderLineType.Float,
            "Highest allele frequency seen in any population" + noteInfix);
  ...
  private void addBestACHeader(VCFHeader header, String prefix, String idInfix, String noteInfix) {
    VCFInfoHeaderLine line =
        new VCFInfoHeaderLine(
            prefix + idInfix + "AC_POPMAX",
            VCFHeaderLineCount.A,
            VCFHeaderLineType.Integer,
            "Allele count for population with highest frequency" + noteInfix);
    header.addMetaDataLine(line);
  }
  ...
  private void addAFHeader(
    ...
    VCFInfoHeaderLine line =
        new VCFInfoHeaderLine(
            ...
            VCFHeaderLineCount.A,
            VCFHeaderLineType.Float,
            "Frequency observed in ExAC data set in " + popName + noteInfix);
    header.addMetaDataLine(line);
  }
