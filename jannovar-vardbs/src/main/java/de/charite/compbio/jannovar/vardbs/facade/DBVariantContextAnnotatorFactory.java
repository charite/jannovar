...
public class DBVariantContextAnnotatorFactory {
   ...
   */
  public DBVariantContextAnnotator constructDBSNP(
      String vcfDBPath, String fastaRefPath, DBAnnotationOptions options)
   ...
   * @throws JannovarVarDBException on problems loading the resources
   */
  public DBVariantContextAnnotator constructExac(
      String vcfDBPath, String fastaRefPath, DBAnnotationOptions options)
      throws JannovarVarDBException {
    return new DBVariantContextAnnotator(
   ...
   * @throws JannovarVarDBException on problems loading the resources
   */
  public DBVariantContextAnnotator constructGnomad(
      String vcfDBPath, String fastaRefPath, DBAnnotationOptions options)
      throws JannovarVarDBException {
    return new DBVariantContextAnnotator(
   ...
   *
   * @param vcfDBPath Path to gzip-compressed, normalized and tbi-indexed thousand genomes file to
   ...
   * @throws JannovarVarDBException on problems loading the resources
   */
  public DBVariantContextAnnotator constructThousandGenomes(
      String vcfDBPath, String fastaRefPath, DBAnnotationOptions options)
      throws JannovarVarDBException {
    return new DBVariantContextAnnotator(
   ...
   * @throws JannovarVarDBException on problems loading the resources
   */
  public DBVariantContextAnnotator constructUK10K(
      String vcfDBPath, String fastaRefPath, DBAnnotationOptions options)
      throws JannovarVarDBException {
    return new DBVariantContextAnnotator(
   ...
   *
   * @param vcfDBPath Path to gzip-compressed, normalized and tbi-indexed ClinVar file to use for
   *     the annotation
   * @param fastaRefPath Path to reference FASTA file
   * @param options Configuration for the variant context annotation
   * @return Preconfigured {@link DBVariantContextAnnotator} object
   * @throws JannovarVarDBException on problems loading the resources
   */
  public DBVariantContextAnnotator constructClinVar(
      String vcfDBPath, String fastaRefPath, DBAnnotationOptions options)
      throws JannovarVarDBException {
    return new DBVariantContextAnnotator(
   ...
   * @throws JannovarVarDBException on problems loading the resources
   */
  public DBVariantContextAnnotator constructCosmic(
      String vcfDBPath, String fastaRefPath, DBAnnotationOptions options)
      throws JannovarVarDBException {
    return new DBVariantContextAnnotator(
        new CosmicAnnotationDriver(vcfDBPath, fastaRefPath, options), options);
   ...
   * @throws JannovarVarDBException on problems loading the resources
   */
  public DBVariantContextAnnotator constructGenericVCF(
      String vcfDBPath, String fastaRefPath, DBAnnotationOptions options)
      throws JannovarVarDBException {
    return new DBVariantContextAnnotator(
        new CosmicAnnotationDriver(vcfDBPath, fastaRefPath, options), options);
