...
public class ThousandGenomesAnnotationDriver
  ...
  public ThousandGenomesAnnotationDriver(
      String vcfPath, String fastaPath, DBAnnotationOptions options) throws JannovarVarDBException {
    super(
        new VCFReaderVariantProvider(vcfPath),
        fastaPath,
        options,
  ...
  protected HashMap<Integer, AnnotatingRecord<ThousandGenomesRecord>> pickAnnotatingDBRecords(
    ...
    HashMap<Integer, AnnotatingRecord<ThousandGenomesRecord>> annotatingG1kRecord = new HashMap<>();
  ...
  @Override
  protected VariantContext annotateWithDBRecords(
      VariantContext vc,
  ...
  private void annotateChromosomeCounts(
      VariantContext vc,
      String infix,
  ...
  private void annotateAlleleHetCounts(
      VariantContext vc,
      String infix,
      HashMap<Integer, AnnotatingRecord<ThousandGenomesRecord>> records,
      VariantContextBuilder builder,
  ...
  private void annotateAlleleHomCounts(
      VariantContext vc,
      String infix,
      HashMap<Integer, AnnotatingRecord<ThousandGenomesRecord>> records,
      VariantContextBuilder builder,
  ...
  private void annotateAlleleHemiCounts(
      VariantContext vc,
      String infix,
      HashMap<Integer, AnnotatingRecord<ThousandGenomesRecord>> records,
      VariantContextBuilder builder,
  ...
  private ThousandGenomesPopulation pickBestPop(
      VariantContext vc, HashMap<Integer, AnnotatingRecord<ThousandGenomesRecord>> records) {
