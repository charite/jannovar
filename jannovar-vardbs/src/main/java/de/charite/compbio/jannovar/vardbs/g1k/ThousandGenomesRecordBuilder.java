...
public class ThousandGenomesRecordBuilder {
  ...
  public ThousandGenomesRecord build() {
    return new ThousandGenomesRecord(
        contig,
        pos,
        id,
        ref,
  ...
  public HashMap<ThousandGenomesPopulation, List<Integer>> getAlleleCounts() {
    return alleleCounts;
  }

  public HashMap<ThousandGenomesPopulation, List<Integer>> getAlleleHetCounts() {
    return alleleHetCounts;
  }

  public HashMap<ThousandGenomesPopulation, List<Integer>> getAlleleHomCounts() {
    return alleleHomCounts;
  }

  public HashMap<ThousandGenomesPopulation, List<Integer>> getAlleleHemiCounts() {
    return alleleHemiCounts;
  }

  public void setAlleleCounts(HashMap<ThousandGenomesPopulation, List<Integer>> alleleCounts) {
    this.alleleCounts = alleleCounts;
  }

  public void setAlleleHetCounts(
      HashMap<ThousandGenomesPopulation, List<Integer>> alleleHetCounts) {
    this.alleleHetCounts = alleleHetCounts;
  }

  public void setAlleleHomCounts(
      HashMap<ThousandGenomesPopulation, List<Integer>> alleleHomCounts) {
    this.alleleHomCounts = alleleHomCounts;
  }

  public void setAlleleHemiCounts(
      HashMap<ThousandGenomesPopulation, List<Integer>> alleleHemiCounts) {
    this.alleleHemiCounts = alleleHemiCounts;
  }

  public HashMap<ThousandGenomesPopulation, ImmutableList<Integer>> getChromCounts() {
    return chromCounts;
  }

  public void setChromCounts(
      HashMap<ThousandGenomesPopulation, ImmutableList<Integer>> chromCounts) {
    this.chromCounts = chromCounts;
  }

  @Override
  public String toString() {
    return "ThousandGenomesRecordBuilder [contig="
        + contig
        + ", pos="
        + pos
        + ", id="
  ...
  public boolean equals(Object obj) {
    ...
    ThousandGenomesRecordBuilder other = (ThousandGenomesRecordBuilder) obj;
