...
public class ThousandGenomesRecordBuilder {
	...
	public void setAlleleHetCounts(HashMap<ThousandGenomesPopulation, List<Integer>> alleleHetCounts) {
		this.alleleHetCounts = alleleHetCounts;
	}

	public void setAlleleHomCounts(HashMap<ThousandGenomesPopulation, List<Integer>> alleleHomCounts) {
		this.alleleHomCounts = alleleHomCounts;
	}

	public void setAlleleHemiCounts(HashMap<ThousandGenomesPopulation, List<Integer>> alleleHemiCounts) {
	...
	public void setChromCounts(HashMap<ThousandGenomesPopulation, ImmutableList<Integer>> chromCounts) {
