 ...
 *
 * <p>Here, we currently only have support for one alternative allele. This reflects more dbNSFP or
 * the CADD score files than VCF files.
 *
...
public class GenericTSVRecord {
  ...
  /**
   * Alternative allele in record, <code>null</code> if locations are annotated instead of variants.
   */
