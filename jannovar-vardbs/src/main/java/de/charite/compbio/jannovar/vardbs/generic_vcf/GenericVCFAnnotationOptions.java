...
public class GenericVCFAnnotationOptions extends DBAnnotationOptions {
   ...
   *
   * <p>The value must be of the format <code>pathToVfFile:prefix:field1,field2,field3</code>.
   */
  public static GenericVCFAnnotationOptions parseFrom(String s) {
    ...
    return new GenericVCFAnnotationOptions(
        true,
        false,
        tokens[1],
  ...
  public GenericVCFAnnotationOptions(
  ...
  public String toString() {
    return "GenericVCFAnnotationOptions [fieldNames="
        + fieldNames
        + ", super="
        + super.toString()
        + ", pathVcfFile="
