...
public class GnomadRecord {
  ...
  private final ImmutableSortedMap<GnomadPopulation, ImmutableList<Integer>> alleleCounts;
  /** Observed alternative allele het counts for each population */
  private final ImmutableSortedMap<GnomadPopulation, ImmutableList<Integer>> alleleHetCounts;
  /** Observed alternative allele hom counts for each population */
  private final ImmutableSortedMap<GnomadPopulation, ImmutableList<Integer>> alleleHomCounts;
  /** Observed alternative allele hemi counts for each population */
  private final ImmutableSortedMap<GnomadPopulation, ImmutableList<Integer>> alleleHemiCounts;
  /**
   * Chromsome counts for each population, for all but POPMAX, one-element list, otherwise multiple
   */
  private final ImmutableSortedMap<GnomadPopulation, ImmutableList<Integer>> chromCounts;
  /** Observed alternative allele frequencies for each population */
  private final ImmutableSortedMap<GnomadPopulation, ImmutableList<Double>> alleleFrequencies;
  ...
  public GnomadRecord(
      ...
      List<String> popmax,
      Map<GnomadPopulation, List<Integer>> alleleCounts,
      Map<GnomadPopulation, List<Integer>> alleleHetCounts,
      Map<GnomadPopulation, List<Integer>> alleleHomCounts,
    ...
    ImmutableSortedMap.Builder<GnomadPopulation, ImmutableList<Integer>> acBuilder =
    ...
    ImmutableSortedMap.Builder<GnomadPopulation, ImmutableList<Integer>> acHetBuilder =
        ImmutableSortedMap.naturalOrder();
    ...
    ImmutableSortedMap.Builder<GnomadPopulation, ImmutableList<Integer>> acHomBuilder =
        ImmutableSortedMap.naturalOrder();
    ...
    ImmutableSortedMap.Builder<GnomadPopulation, ImmutableList<Integer>> acHemiBuilder =
        ImmutableSortedMap.naturalOrder();
    ...
    ImmutableSortedMap.Builder<GnomadPopulation, ImmutableList<Double>> afBuilder =
        ImmutableSortedMap.naturalOrder();
    for (Entry<GnomadPopulation, ImmutableList<Integer>> e : this.alleleCounts.entrySet()) {
      ...
      for (int x : e.getValue()) {
        int count;
        if (pop == GnomadPopulation.POPMAX) count = counts.get(i);
  ...
  /**
   * @return {@link GnomadPopulation} with highest allele frequency for the given allele index (0 is
   *     first alternative allele)
   */
