 ...
 */
public class CosmicAnnotationDriverReportOverlappingAsMatchingTest
    extends CosmicAnnotationDriverBaseTest {
  ...
  public void testAnnotateVariantContext() throws JannovarVarDBException {
    ...
    Assert.assertEquals(
        "[COSM814119, COSM814119, COSM814119]", annotated.getAttributeAsString("IDS", null));
