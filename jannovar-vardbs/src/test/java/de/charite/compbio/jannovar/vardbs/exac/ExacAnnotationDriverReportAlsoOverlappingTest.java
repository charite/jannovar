...
public class ExacAnnotationDriverReportAlsoOverlappingTest extends ExacAnnotationDriverBaseTest {
  ...
  public void testAnnotateVariantContext() throws JannovarVarDBException {
    ...
    Assert.assertEquals(
        "[AC_AFR, AC_ALL, AC_AMR, AC_EAS, AC_FIN, AC_NFE, AC_OTH, AC_POPMAX, AC_SAS, "
            + "AF_AFR, AF_ALL, "
            ...
            + "OVL_HOM_AFR, OVL_HOM_ALL, OVL_HOM_AMR, OVL_HOM_EAS, OVL_HOM_FIN, OVL_HOM_NFE, OVL_HOM_OTH, OVL_HOM_SAS]",
        keys.toString());
    ...
    Assert.assertEquals(
        "[0.0, 0.003194888178913738, 0.0]", annotated.getAttributeAsString("AF_AFR", null));
    Assert.assertEquals(
        "[0.0, 1.7041581458759374E-4, 0.0]", annotated.getAttributeAsString("AF_ALL", null));
    ...
    Assert.assertEquals(
        "[0.003194888178913738, 0.003194888178913738, 0.003194888178913738]",
        annotated.getAttributeAsString("OVL_AF_AFR", null));
    Assert.assertEquals(
        "[1.7041581458759374E-4, 1.7041581458759374E-4, 1.7041581458759374E-4]",
    ...
    Assert.assertEquals(
        "[0.0, 0.003194888178913738, 0.0]", annotated.getAttributeAsString("AF_POPMAX", null));

    Assert.assertEquals("[2, 2, 2]", annotated.getAttributeAsString("OVL_AC_POPMAX", null));
    Assert.assertEquals(
        "[0.003194888178913738, 0.003194888178913738, 0.003194888178913738]",
