 ...
 */
public class ExacAnnotationDriverReportOverlappingAsMatchingTest
    extends ExacAnnotationDriverBaseTest {
  ...
  public void testAnnotateVariantContext() throws JannovarVarDBException {
    ...
    Assert.assertEquals(
        "[AC_AFR, AC_ALL, AC_AMR, AC_EAS, AC_FIN, AC_NFE, AC_OTH, AC_POPMAX, AC_SAS, AF_AFR, AF_ALL, "
    ...
    Assert.assertEquals("[2, 2, 2]", annotated.getAttributeAsString("AC_POPMAX", null));
    Assert.assertEquals(
        "[0.003194888178913738, 0.003194888178913738, 0.003194888178913738]",
