...
public class GenericTSVAnnotationDriverWithDbnsfpReportAlsoOverlappingTest
	...
	public void testAnnotateExtendHeader() throws JannovarVarDBException {
		...
		Assertions.assertNotNull(header.getInfoHeaderLine("DBNSFP_OVL_AAREF"));
		Assertions.assertNotNull(header.getInfoHeaderLine("DBNSFP_OVL_RS_DBSNP147"));
		Assertions.assertNotNull(header.getInfoHeaderLine("DBNSFP_OVL_HG19POS"));
		Assertions.assertNotNull(header.getInfoHeaderLine("DBNSFP_OVL_SIFT_SCORE"));
	}
	...
	public void testAnnotateVariantContext() throws JannovarVarDBException {
		...
		Assertions.assertEquals("[DBNSFP_AAREF, DBNSFP_HG19POS, DBNSFP_OVL_AAREF, DBNSFP_OVL_HG19POS, "
