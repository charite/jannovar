...
public class GnomadExomesAnnotationDriverBaseTest {
	...
	public void setUpClass() throws Exception {
		...
		gnomadVCFPath = tmpDir + "/gnomad.exomes.vcf.gz";
		ResourceUtils.copyResourceToFile("/gnomad.exomes.r2.0.1.sites.head.vcf.gz", new File(gnomadVCFPath));
		String exomesTbiPath = tmpDir + "/gnomad.exomes.vcf.gz.tbi";
		ResourceUtils.copyResourceToFile("/gnomad.exomes.r2.0.1.sites.head.vcf.gz.tbi", new File(exomesTbiPath));
