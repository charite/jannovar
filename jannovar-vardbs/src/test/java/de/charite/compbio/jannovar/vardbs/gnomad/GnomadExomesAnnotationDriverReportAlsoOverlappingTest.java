 ...
 */
public class GnomadExomesAnnotationDriverReportAlsoOverlappingTest
  ...
  public void testAnnotateVariantContext() throws JannovarVarDBException {
    ...
    Assert.assertEquals(
        "[2.7533039647577095E-4, 2.7533039647577095E-4, 2.7533039647577095E-4]",
        annotated.getAttributeAsString("OVL_AF_AFR", null));
    Assert.assertEquals(
        "[7.552756000664643E-6, 7.552756000664643E-6, 7.552756000664643E-6]",
