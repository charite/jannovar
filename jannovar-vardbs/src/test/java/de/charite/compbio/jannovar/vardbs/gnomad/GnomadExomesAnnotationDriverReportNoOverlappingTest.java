 ...
 */
public class GnomadExomesAnnotationDriverReportNoOverlappingTest
    extends GnomadExomesAnnotationDriverBaseTest {
  ...
  public void testAnnotateExtendHeaderWithDefaultPrefix() throws JannovarVarDBException {
    ...
    Assert.assertNotNull(header.getInfoHeaderLine("GNOMAD_HET_POPMAX"));
  ...
  public void testAnnotateVariantContext() throws JannovarVarDBException {
    ...
    Assert.assertEquals("[0, 0, 0]", annotated.getAttributeAsString("AC_ASJ", null));
    ...
    Assert.assertEquals(
        "[0.0, 2.7533039647577095E-4, 0.0]", annotated.getAttributeAsString("AF_AFR", null));
    Assert.assertEquals(
        "[0.0, 7.552756000664643E-6, 0.0]", annotated.getAttributeAsString("AF_ALL", null));
    Assert.assertEquals("[0.0, 0.0, 0.0]", annotated.getAttributeAsString("AF_AMR", null));
    Assert.assertEquals("[0.0, 0.0, 0.0]", annotated.getAttributeAsString("AF_ASJ", null));
    ...
    Assert.assertEquals(
        "[0.0, 2.7533039647577095E-4, 0.0]", annotated.getAttributeAsString("AF_POPMAX", null));
    ...
    Assert.assertEquals("[7918]", annotated.getAttributeAsString("AN_ASJ", null));
    ...
    Assert.assertEquals("[0, 7264]", annotated.getAttributeAsString("AN_POPMAX", null));
    ...
    Assert.assertEquals("[0, 0, 0]", annotated.getAttributeAsString("HET_ASJ", null));
    ...
    Assert.assertEquals("[0, 2, 0]", annotated.getAttributeAsString("HET_POPMAX", null));
    ...
    Assert.assertEquals("[., AFR, .]", annotated.getAttributeAsString("POPMAX", null));
  }
}
