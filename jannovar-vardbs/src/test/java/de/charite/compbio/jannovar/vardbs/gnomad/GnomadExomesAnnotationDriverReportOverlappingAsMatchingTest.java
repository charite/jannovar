...
public class GnomadExomesAnnotationDriverReportOverlappingAsMatchingTest extends GnomadExomesAnnotationDriverBaseTest {
	...
	public void testAnnotateVariantContext() throws JannovarVarDBException {
		...
		Assertions.assertEquals("[2, 2, 2]", annotated.getAttributeAsString("AC_AFR", null));
		Assertions.assertEquals("[2, 2, 2]", annotated.getAttributeAsString("AC_ALL", null));
		...
		Assertions.assertEquals("[2, 2, 2]", annotated.getAttributeAsString("HET_AFR", null));
		Assertions.assertEquals("[2, 2, 2]", annotated.getAttributeAsString("HET_ALL", null));
