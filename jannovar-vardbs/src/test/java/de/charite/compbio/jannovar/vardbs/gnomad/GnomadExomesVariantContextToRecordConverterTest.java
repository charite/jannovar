...
public class GnomadExomesVariantContextToRecordConverterTest {
  ...
  public static void setUpClass() throws Exception {
    ...
    ResourceUtils.copyResourceToFile(
        "/gnomad.exomes.r2.0.1.sites.head.vcf.gz.tbi", new File(tbiPath));
  ...
  public void test() {
    ...
    Assert.assertEquals(
        "GnomadRecord [chrom=1, pos=12197, id=rs62635282, ref=G, alt=[C], filter=[AC0], "
            ...
            + "NFE=[0.0], OTH=[0.0], SAS=[0.0], POPMAX=[0.0], ALL=[0.0]}]",
        record.toString());
  }
}
