 ...
 */
public class GnomadGenomesAnnotationDriverReportAlsoOverlappingTest
  ...
  public void testAnnotateVariantContext() throws JannovarVarDBException {
    ...
    Assert.assertEquals(
        "[0.0, 0.3488372093023256, 0.018272425249169437]",
        annotated.getAttributeAsString("AF_AFR", null));
    Assert.assertEquals(
        "[0.0, 0.04265202702702703, 0.0015484234234234234]",
        annotated.getAttributeAsString("AF_ALL", null));
    Assert.assertEquals(
        "[0.0, 0.013888888888888888, 0.0]", annotated.getAttributeAsString("AF_AMR", null));
    Assert.assertEquals(
        "[0.0, 0.027777777777777776, 0.0]", annotated.getAttributeAsString("AF_ASJ", null));
    Assert.assertEquals(
        "[0.0, 0.5571428571428572, 0.0]", annotated.getAttributeAsString("AF_EAS", null));
    Assert.assertEquals("[0.0, 0.0, 0.0]", annotated.getAttributeAsString("AF_FIN", null));
    Assert.assertEquals(
        "[0.0, 0.02346938775510204, 0.0]", annotated.getAttributeAsString("AF_NFE", null));
    Assert.assertEquals(
        "[0.0, 0.061224489795918366, 0.0]", annotated.getAttributeAsString("AF_OTH", null));
    Assert.assertEquals(
        "[0.0, 0.5571428571428572, 0.018272425249169437]",
    ...
    Assert.assertEquals(
        "[0.04265202702702703, 0.04265202702702703, 0.04265202702702703]",
    ...
    Assert.assertEquals(
        "[0.5571428571428572, 0.5571428571428572, 0.5571428571428572]",
    ...
    Assert.assertEquals(
        "[0.02346938775510204, 0.02346938775510204, 0.02346938775510204]",
