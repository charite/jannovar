 ...
 * class will be created by the parsers {@link jannovar.io.dbSNP2FrequencyParser dbSNP2FrequencyParser}
 * as well as {@link jannovar.io.ESP2FrequencyParser ESP2FrequencyParser} during parsing, and
 ...
 * {@link jannovar.io.dbSNP2FrequencyParser dbSNP2FrequencyParser} therefore converts the
 * data in dbSNP to percentages for uniformity's sake.
 * <P>
 * Note that this class implements {@code Comparable} because it is intended
 * to be used as an element of a {@code TreeSet} in the class {@link jannovar.dbSNP2SQL dbSNP2SQL}
