...
- use `Sequence Ontology <http://charite.github.io/jannovar/api/0.25/de/charite/compbio/jannovar/annotation/VariantEffect.html>`_ for variant effect annotation
