 ...
 * various parts of the program, some of which will cause the program to terminate and some will note. In any case, we
 * want to terminate gracefully so that it is possible to print an HTML error message for users if say there are major
