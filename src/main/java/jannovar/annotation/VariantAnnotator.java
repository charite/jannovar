	...
	private void annotateExonicVariants(int refvarstart, int refvarend, int start, int end, String ref, String var,
		...
		if (start == end) { /* SNV or insertion variant */
			if (ref.equals("-")) { /* "-" stands for an insertion at this position */
				...
				Annotation dlt = null; /*DeletionAnnotationBuilderTest.getAnnotationSingleNucleotide(tm, frame_s, wtnt3,
			 ...
			 * nucleotides.
			 */
			Annotation dltmnt = null;
//			DeletionAnnotationBuilderTest.getMultinucleotideDeletionAnnotation(tm, frame_s, wtnt3,
