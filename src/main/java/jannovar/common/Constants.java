...
/**
 * This interface has some numerical contants that are used by various other classes in the Exomizer to refer to various
 * entities. Chromosomes 1-22 are refered to by the corresponding ints, and chromosomes X, Y, and M are referred to as
 * below.
 *
...
public interface Constants {
	...
	/*
	 * 4) Index of fields of the DP4 (depth) from the VCF file: ref-forward bases, ref-reverse, alt-forward and
	 * alt-reverse bases
	 */
