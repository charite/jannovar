...
/**
 * This is a simple class of enumerated constants that describe the type of filtering that was applied to a
 * Gene/Variant. This class is placed in the jannovar hierarchy for now because it is intertwined with Variant.
 *
 * @author Peter Robinson
 * @version 0.01 (22 April, 2013)
 */
// TODO(robinson): it should be put into the Exomizer hierarchy.
