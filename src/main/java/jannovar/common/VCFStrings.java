...
public class VCFStrings {
	 ...
	 */
	public static final String INFO_EFFECT = "##INFO=<ID=EFFECT,Number=1,Type=String,Description=\""
	 ...
	 * original VCF file.
	 */
	public static final String INFO_HGVS = "##INFO=<ID=HGVS,Number=1,Type=String,Description=\"HGVS Nomenclature\">";
