...
/**
 * This class and its two subclasses provide the flexibility needed to deal with the various kinds of VCF file formats.
 * For instance, VCF files may contain a single sample or multiple samples, and they may have different attributes
 * depending on the actual format of the VCF file as defined in the FORMAT field, e.g.,
 * 
 * <PRE>
 * GT:AD:DP:GQ:PL
 * </PRE>
 * 
 * This class is an implementation of the abstract factory design pattern. The clients of the class are concrete
 * instances of the Genotype abstract class. These in turn have various interfaces to describe the possible variations
 * in VCF format.
 * 
...
public abstract class GenotypeFactoryA {
	/**
	 * This is the core method of the factory, and creates a {@link jannovar.genotype.GenotypeCall GenotypeCall} object.
	 * 
	 * @param A
	 *            an array of Strings with the tab-separated fields of a VCF line.
	...
	/**
	 * @param q
	 *            The PHRED quality score represented as a String
	...
	/**
	 * @param DP
	 *            the DEPTH of a VCF file (which is within the Genotype Field)
	...
	Genotype parseGenotypeString(String genot) {
		...
		if (genot.equals("0/1") || genot.equals("0|1") || genot.equals("1/0") || genot.equals("1|0") || genot.equals("0/2"))
