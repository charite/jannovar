...
/**
 * The Feature stores the data of one line in a GFT of GFF file. The GFT format is an extension or flavor of the GFF
 * format. They boith share the first eight columns:<br>
...
public class Feature {
	...
	double score;
	/**
	 * The strand of the feature. <code>true</code> for positive strand (relative to the {@link #sequence_id landmark}),
	...
	/**
	 * Adds a new attribute to the list of attributes. If the attribute id already exists, it is String appended.
	 * Multiple attributes of the same type are indicated by separating the values with the comma "," character. There
	 * are some predefined meanings for the attribute tags:<br>
