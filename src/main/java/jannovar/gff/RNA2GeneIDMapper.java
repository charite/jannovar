...
/**
 * The {@link RNA2GeneIDMapper} generates integer gene ids from given Gennames etc. v0.1 only Ensemble gene ids are
 * currently working
 *
 * @author mjaeger
...
public class RNA2GeneIDMapper {
	 ...
	 *
	 * @param geneName
	 *            A gene identifier (e.g. Ensembl ENSG00000000419)
