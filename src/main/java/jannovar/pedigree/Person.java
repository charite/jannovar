...
public class Person {
	...
	/**
	 * The ID of the father of this person in the pedigree. Note: If this person is a founder, then mother and father ID
	 * are both "0".
	 */
	private String fatherID = null;
	/**
	 * A reference to the Person object of the father of this person. If this person is a founder, then this reference
	 * is null.
	 */
	private Person father = null;
	/**
	 * The ID of the mother of this person in the pedigree. Note: If this person is a founder, then mther and father ID
	 * are both "0".
	 */
	private String motherID = null;
	/**
	 * A reference to the Person object of the mother of this person. * If this person is a founder, then this reference
	 * is null.
	 */
	private Person mother = null;

	/**
	 * In the pedfile, this corresponds to (1 = Male, 2 = Female, 0 = Unkown)
	 */
	...
	/**
	 * This variable is used to enable flexible searching within the {@link jannovar.pedigree.Pedigree Pedigree} object.
	 * It corresponds to the index of the Person in the list of persons of the pedigree.
	 */
	private int index;
