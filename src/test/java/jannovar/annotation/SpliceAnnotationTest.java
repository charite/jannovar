...
public class SpliceAnnotationTest implements Constants {
	...
	public void testSpliceVar1h4() throws AnnotationException {
		...
		String annot = ann.getVariantAnnotation();
		Assert.assertEquals(
				"ASH1L(uc001fkt.3:exon19:complicated_splice_mutation,uc009wqq.3:exon19:complicated_splice_mutation)",
				annot);
	}
	...
	public void testSpliceVar3h() throws AnnotationException {
		...
		String annot = ann.getVariantAnnotation();
		Assert.assertEquals(
				"KIRREL(uc001fro.4:exon10:c.1239+2T>C,uc009wsq.3:exon11:c.1305+2T>C,uc010pib.2:exon12:c.1497+2T>C,uc001frn.4:exon14:c.1797+2T>C)",
				annot);
	}
	...
	public void testSpliceVar4h() throws AnnotationException {
		...
		String annot = ann.getVariantAnnotation();
		Assert.assertEquals(
				"NSL1(uc001hjn.3:exon1:c.234+2T>C,uc001hjm.3:exon1:c.234+2T>C,uc010pti.2:exon1:c.234+2T>C)", annot);
	}
	...
	public void testSpliceVar6h() throws AnnotationException {
		...
		String annot = ann.getVariantAnnotation();
		Assert.assertEquals(
				"MTA3(uc002rso.1:exon7:c.214-2A>G,uc002rsp.1:exon6:c.214-2A>G,uc002rsq.3:exon6:c.382-2A>G)", annot);
	}
	...
	public void testSpliceVar9h() throws AnnotationException {
		...
		String annot = ann.getVariantAnnotation();
		Assert.assertEquals(
				"NPHP1(uc002tfo.4:exon4:c.337-1G>A,uc002tfm.4:exon6:c.523-1G>A,uc002tfl.4:exon6:c.523-1G>A,uc002tfn.4:exon6:c.523-1G>A,uc010ywx.2:exon6:c.523-1G>A,uc010fjv.1:exon6:c.523-1G>A)",
				annot);
	}
