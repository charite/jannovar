...
public class TranscriptSequenceOntologyDecoratorTest {
	...
	public void testLiesInIntron() {
		...
		Assert.assertFalse(decorator
				.liesInIntron(new GenomeInterval('+', 1, 6640195, 6640600, PositionType.ZERO_BASED)));
		Assert.assertTrue(decorator.liesInIntron(new GenomeInterval('+', 1, 6640196, 6640600, PositionType.ZERO_BASED)));
		Assert.assertFalse(decorator
				.liesInIntron(new GenomeInterval('+', 1, 6640196, 6640601, PositionType.ZERO_BASED)));
	}
	...
	public void testOverlapsWithSpliceRegion() {
		...
		// donor region
		Assert.assertFalse(decorator.overlapsWithSpliceRegion(new GenomeInterval('+', 1, 6642350, 6642356,
				PositionType.ZERO_BASED)));
		Assert.assertTrue(decorator.overlapsWithSpliceRegion(new GenomeInterval('+', 1, 6642350, 6642357,
				PositionType.ZERO_BASED)));
		Assert.assertTrue(decorator.overlapsWithSpliceRegion(new GenomeInterval('+', 1, 6642366, 6642370,
				PositionType.ZERO_BASED)));
		Assert.assertFalse(decorator.overlapsWithSpliceRegion(new GenomeInterval('+', 1, 6642367, 6642370,
				PositionType.ZERO_BASED)));

		// acceptor region
		Assert.assertFalse(decorator.overlapsWithSpliceRegion(new GenomeInterval('+', 1, 6642100, 6642109,
				PositionType.ZERO_BASED)));
		Assert.assertTrue(decorator.overlapsWithSpliceRegion(new GenomeInterval('+', 1, 6642100, 6642110,
				PositionType.ZERO_BASED)));
		Assert.assertTrue(decorator.overlapsWithSpliceRegion(new GenomeInterval('+', 1, 6642119, 6642125,
				PositionType.ZERO_BASED)));
		Assert.assertFalse(decorator.overlapsWithSpliceRegion(new GenomeInterval('+', 1, 6642120, 6642125,
				PositionType.ZERO_BASED)));
	}
	...
	public void testOverlapsWithSpliceDonorSite() {
		...
		Assert.assertFalse(decorator.overlapsWithSpliceAcceptorSite(new GenomeInterval('+', 1, 6645978, 6645980,
				PositionType.ZERO_BASED)));
		Assert.assertTrue(decorator.overlapsWithSpliceAcceptorSite(new GenomeInterval('+', 1, 6645977, 6645980,
				PositionType.ZERO_BASED)));
		Assert.assertTrue(decorator.overlapsWithSpliceAcceptorSite(new GenomeInterval('+', 1, 6645975, 6645977,
				PositionType.ZERO_BASED)));
		Assert.assertFalse(decorator.overlapsWithSpliceAcceptorSite(new GenomeInterval('+', 1, 6645972, 6645976,
				PositionType.ZERO_BASED)));
	}
	...
	public void testOverlapsWithSpliceAcceptorSite() {
		...
		Assert.assertFalse(decorator.overlapsWithSpliceAcceptorSite(new GenomeInterval('+', 1, 6642117, 6642119,
				PositionType.ZERO_BASED)));
		Assert.assertTrue(decorator.overlapsWithSpliceAcceptorSite(new GenomeInterval('+', 1, 6642116, 6642119,
				PositionType.ZERO_BASED)));
		Assert.assertTrue(decorator.overlapsWithSpliceAcceptorSite(new GenomeInterval('+', 1, 6642113, 6642117,
				PositionType.ZERO_BASED)));
		Assert.assertFalse(decorator.overlapsWithSpliceAcceptorSite(new GenomeInterval('+', 1, 6642112, 6642115,
				PositionType.ZERO_BASED)));
	}
	...
	public void testOverlapsWithUpstreamRegion() {
		...
		Assert.assertFalse(decorator.overlapsWithUpstreamRegion(new GenomeInterval('+', 1, 6640062, 6640064,
				PositionType.ZERO_BASED)));
		Assert.assertTrue(decorator.overlapsWithUpstreamRegion(new GenomeInterval('+', 1, 6640061, 6640064,
				PositionType.ZERO_BASED)));
		Assert.assertFalse(decorator.overlapsWithUpstreamRegion(new GenomeInterval('+', 1, 6638062, 6639062,
				PositionType.ZERO_BASED)));
	...
	public void testOverlapsWithDownstreamRegion() {
		...
		Assert.assertFalse(decorator.overlapsWithDownstreamRegion(new GenomeInterval('+', 1, 6649339, 6649340,
				PositionType.ZERO_BASED)));
		Assert.assertTrue(decorator.overlapsWithDownstreamRegion(new GenomeInterval('+', 1, 6649340, 6649341,
				PositionType.ZERO_BASED)));
		Assert.assertFalse(decorator.overlapsWithDownstreamRegion(new GenomeInterval('+', 1, 6650340, 6651340,
				PositionType.ZERO_BASED)));
	}
	...
	public void testOverlapsWithFivePrimeUTR() {
		...
		Assert.assertFalse(decorator.overlapsWithFivePrimeUTR(new GenomeInterval('+', 1, 6640669, 6640670,
				PositionType.ZERO_BASED)));
		Assert.assertTrue(decorator.overlapsWithFivePrimeUTR(new GenomeInterval('+', 1, 6640668, 6640670,
				PositionType.ZERO_BASED)));
		Assert.assertFalse(decorator.overlapsWithFivePrimeUTR(new GenomeInterval('+', 1, 6640061, 6640062,
				PositionType.ZERO_BASED)));
	...
	public void testOverlapsWithThreePrimeUTR() {
		...
		Assert.assertFalse(decorator.overlapsWithThreePrimeUTR(new GenomeInterval('+', 1, 6649270, 6649272,
				PositionType.ZERO_BASED)));
		Assert.assertTrue(decorator.overlapsWithThreePrimeUTR(new GenomeInterval('+', 1, 6649270, 6649273,
				PositionType.ZERO_BASED)));
		Assert.assertFalse(decorator.overlapsWithThreePrimeUTR(new GenomeInterval('+', 1, 6649340, 6649341,
				PositionType.ZERO_BASED)));
